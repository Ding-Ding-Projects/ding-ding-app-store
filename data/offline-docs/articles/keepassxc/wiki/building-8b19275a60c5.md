...
Native dependencies are declared in `vcpkg.json`: Botan 3, minizip, libqrencode, zlib, readline.
...
> ```bash
> git -C "$HOME/vcpkg" fetch --depth 1 origin 
> ```
...
See [Passkeys](app-doc://article/keepassxc.wiki.90ea56934ad697e1) for what the passkey suite covers.
