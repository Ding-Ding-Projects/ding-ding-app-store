...
- [Reliable transfers](app-doc://article/material-download-manager.repository.ac97334b68a84883) — the local segmented-transfer
  path used for safe fallback.
- [Browser handoff](app-doc://article/material-download-manager.repository.0edd557d6d0d5352) — bounded URL capture
  into the same main-process queue.
- [Destructive action gate](app-doc://article/material-download-manager.repository.88d8089e0ac82fab) — review the
