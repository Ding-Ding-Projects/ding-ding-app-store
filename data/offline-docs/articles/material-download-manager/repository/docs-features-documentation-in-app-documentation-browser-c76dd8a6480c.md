...
- [Regex builder](app-doc://article/material-download-manager.repository.712b778d4e612b02) — understand the search dialect
  and safety bounds used by the browser.
- [Tabbed navigation](app-doc://article/material-download-manager.repository.548bf1e0f6d6578c) — see how the
