...
- Each visible entry renders the full 40-character source SHA as a link to
  https://github.com/Ding-Ding-Projects/material-download-manager/commit/.
...
- [History browser panel](app-doc://article/material-download-manager.repository.fe8522105f3f9fd1) — compare published
  releases with local state revisions.
- [Search](app-doc://article/material-download-manager.repository.11eb380f970a769f) — understand the shared search and regex
  builder behavior.
- [Export](app-doc://article/material-download-manager.repository.cdbcbdd02fa6497a) — review supported filtered export formats.
