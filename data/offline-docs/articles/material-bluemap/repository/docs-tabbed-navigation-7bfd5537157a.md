...
[super-confirmation gate](app-doc://article/material-bluemap.repository.d3717539aefc5d60).
...
- [Home](app-doc://article/material-bluemap.repository.f978182d9929e62f), the one page every install - fresh or upgrading - is guaranteed a pinned tab
  for, and the reason `pinnedPageIds`/`ensurePage` exist at all.
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60), which stands in front of every bulk close.
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75), which supplies all four
  tab searches and both bulk-close fields.
- [Appearance editors](app-doc://article/material-bluemap.repository.f1073e3c30c44e85), which owns the records the tab model carries but
  never reads.
