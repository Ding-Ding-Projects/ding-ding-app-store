...
the config folder's own [local version history](app-doc://article/material-bluemap.repository.b950930a933f6a3e) is asked to snapshot it, so
...
- [Running the engine on this computer, or in a container](app-doc://article/material-bluemap.repository.5db9c82f867c7897) — the two ways a
  run can be started, and the container-specific failures the repair pass recognises.
- [Local version history for config folders](app-doc://article/material-bluemap.repository.b950930a933f6a3e) — where an automatic change is
  recorded, and how it is undone.
- [Renders that survive being interrupted](app-doc://article/material-bluemap.repository.334128592026c1b2) — what happens to a render that
