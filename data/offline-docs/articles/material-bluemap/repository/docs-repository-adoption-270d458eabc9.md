...
screen's 37 tests - see [A world kept in a git repository](app-doc://article/material-bluemap.repository.9a6c624f146e7d78)'s own
...
- [A world kept in a git repository](app-doc://article/material-bluemap.repository.9a6c624f146e7d78) - the world-repo marker and
  the branch it lives on.
- [The project file](app-doc://article/material-bluemap.repository.b950930a933f6a3e) - the local version history a restored project
  joins once it is saved into a world folder.
- [Finding worlds](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9) - the guided world-folder step adoption's
  `"world-folder"` attention item leads into.
- [Rendering a world in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) - what a CI-bootstrap marker
