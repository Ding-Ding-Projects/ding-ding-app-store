...
project's own backups — see [Backing up a world or a rendered map](app-doc://article/material-bluemap.repository.fdf6f35fb97bc1a7). 1 GB of
...
[Publishing a rendered map to GitHub Pages](app-doc://article/material-bluemap.repository.9329e185bf79a100) solved a structurally
...
--single-branch --branch ` — which is the whole saving a plain clone misses: no
...
[Scheduled re-rendering](app-doc://article/material-bluemap.repository.2e16c8f63b4747c4)'s `evaluateScheduleChange` in
...
- [Adopting a repository this app already prepared](app-doc://article/material-bluemap.repository.270d458eabc9ba04) — the other
...
- [Publishing a rendered map to GitHub Pages](app-doc://article/material-bluemap.repository.9329e185bf79a100) — the design this
  feature reuses, for the opposite direction: a rendered map going out, rather than a world
  coming in.
- [Worlds from somebody else's release](app-doc://article/material-bluemap.repository.ae963fc72bd07ef6) — the other way a world can live
  outside this computer, and when a repository is not the right choice.
- [Scheduled re-rendering](app-doc://article/material-bluemap.repository.2e16c8f63b4747c4) — what reads the cheap change check this
  feature exposes.
- [Rendering a world in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) — the sharded render this
  feature's world feeds into, and why sparse checkout was rejected for it.
- [Backing up a world or a rendered map](app-doc://article/material-bluemap.repository.fdf6f35fb97bc1a7) — why Git LFS was rejected on cost,
  here and there.
