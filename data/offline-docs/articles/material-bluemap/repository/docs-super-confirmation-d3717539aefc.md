...
[voice-not-facts rule](app-doc://article/material-bluemap.repository.bfab28ebad332d8c) is what keeps the naming intact at every level.
...
- [Tabbed navigation](app-doc://article/material-bluemap.repository.7bfd5537157accc8), whose bulk closes are the largest thing behind this
  gate.
- [Language modes and funny levels](app-doc://article/material-bluemap.repository.bfab28ebad332d8c), for why a level 5 gate still names
  the file.
- [Notification centre](app-doc://article/material-bluemap.repository.f44b3a9ab4be8af3), for the opposite rule: what must never block.
