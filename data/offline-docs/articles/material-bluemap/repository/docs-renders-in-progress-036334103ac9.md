...
on every route, kept going untouched. See [Docker and local rendering](app-doc://article/material-bluemap.repository.5db9c82f867c7897)
and [Rendering in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) for how each route actually runs;
...
- [Render console](app-doc://article/material-bluemap.repository.33011b9dbbe4fe25) for the single-render detail view this page's **Open
  console** action leads to.
- [Docker and local rendering](app-doc://article/material-bluemap.repository.5db9c82f867c7897) for how a container survives the
  application closing, and how it is found again.
- [Rendering in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) for the third route, entirely
  independent of this application.
- [Super-confirmation for destructive actions](app-doc://article/material-bluemap.repository.d3717539aefc5d60) for the gate bulk
  cancellation goes through.
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75) for the shared search
