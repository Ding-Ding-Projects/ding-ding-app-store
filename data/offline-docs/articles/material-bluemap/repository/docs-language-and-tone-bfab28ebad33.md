...
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60), the surface where voice-not-facts matters most,
  and one of the surfaces the catalogue already covers.
- [The notification centre](app-doc://article/material-bluemap.repository.f44b3a9ab4be8af3), whose own copy is in the catalogue.
- [The command palette](app-doc://article/material-bluemap.repository.e8c7bcf1c71044a6), whose copy is not in the catalogue yet and which
