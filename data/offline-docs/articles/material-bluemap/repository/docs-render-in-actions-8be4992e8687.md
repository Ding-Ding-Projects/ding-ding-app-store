...
the button, see [Scheduled re-rendering](app-doc://article/material-bluemap.repository.2e16c8f63b4747c4): a separate workflow checks
...
directory name —
`BlueMapConfigManager.sanitiseMapId`:
...
`design/packages/render-actions/src/bluemap.ts`,
...
([render-console.md](app-doc://article/material-bluemap.repository.33011b9dbbe4fe25)). **GitHub Pages does no such thing.** It serves
...
| Limit                                                | What happens                                                                                                                                                                |
| ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A map delivered in parts (more than one merge group) | Publishing is skipped, with a note in the run summary. No single runner ever holds the whole map, which is the point of the split — see [large-worlds.md](app-doc://article/material-bluemap.repository.5c9cca2da575c81d). |
...
same public-repository warning, word for word ([backup.md](app-doc://article/material-bluemap.repository.fdf6f35fb97bc1a7)). The transfer and
...
before it. [resumable-renders.md](app-doc://article/material-bluemap.repository.334128592026c1b2) has the arithmetic, the caching and
...
[large-worlds.md's "Measured: a real two-wave hosted dispatch"](app-doc://article/material-bluemap.repository.5c9cca2da575c81d#measured-a-real-two-wave-hosted-dispatch)
...
free disk by a wide margin — see [world-sources.md](app-doc://article/material-bluemap.repository.ae963fc72bd07ef6), where a runner
...
[resumable-renders.md](app-doc://article/material-bluemap.repository.334128592026c1b2#how-rstate-is-cached-without-reintroducing-the-merge-bug)
...
- **Six hours per job.** The workflow sets a 350-minute timeout and the render step a
  ...
  [resumable-renders.md](app-doc://article/material-bluemap.repository.334128592026c1b2).
...
*Image omitted from the offline bundle: Hosted tiny test world in the BlueMap viewer.*
