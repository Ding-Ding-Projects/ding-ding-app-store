...
- [Tabbed navigation](app-doc://article/material-bluemap.repository.7bfd5537157accc8), whose four searches and two bulk-close fields are
  the heaviest consumer of the builder.
- [The command palette](app-doc://article/material-bluemap.repository.e8c7bcf1c71044a6) and
  [the notification centre](app-doc://article/material-bluemap.repository.f44b3a9ab4be8af3), two surfaces built around one of these
  fields.
- [Appearance editors](app-doc://article/material-bluemap.repository.f1073e3c30c44e85), where the builder reaches the pickers themselves.
