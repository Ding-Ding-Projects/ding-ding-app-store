...
[`@worldlens/parts`](app-doc://article/material-bluemap.repository.5c9cca2da575c81d) splits a file into checksummed parts and rejoins
...
`DownloadRowCard.vue`'s own log use — see [Render console](app-doc://article/material-bluemap.repository.33011b9dbbe4fe25) for the full
...
[Large worlds and rendered maps](app-doc://article/material-bluemap.repository.5c9cca2da575c81d) documents — and that was never true. That path
...
[super-confirmation gate](app-doc://article/material-bluemap.repository.d3717539aefc5d60) and one accidental click; leaving it out means
...
- [Large worlds and rendered maps](app-doc://article/material-bluemap.repository.5c9cca2da575c81d) — the split-and-rejoin machinery a backup
  uses, and the download half that restores one.
- [Rendering a world that lives in a private repository](app-doc://article/material-bluemap.repository.6e690895b62b560a) — the other
  place this project puts a world on GitHub, and what that does and does not protect.
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60) — the gate a delete would need, and why append-only
  means there is nothing here to gate.
- [Finding worlds](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9) — where the worlds offered as backup sources come from.
