...
2. **Told plainly, then it happens.** Nothing downloads as a side effect of asking a question.
   ...
   [Mojang download consent](app-doc://article/material-bluemap.repository.f264728f2be3d5ce) already uses, extended to every other tool
...
[Fetching a Java runtime for itself](app-doc://article/material-bluemap.repository.f3dac92a3dcbc0bd) is the full account: the
...
(MIT-licensed) — see [Bedrock Edition worlds](app-doc://article/material-bluemap.repository.1fd420469f2042a1) for what conversion does and
...
[Fetching a Java runtime for itself § Verification](app-doc://article/material-bluemap.repository.f3dac92a3dcbc0bd#verification);
this is the rest:
...
- [The Minecraft licence and the consent that refers to it](app-doc://article/material-bluemap.repository.f264728f2be3d5ce) — the
  asked-once-remembered-forever shape every download consent in this app follows.
- [Bedrock Edition worlds](app-doc://article/material-bluemap.repository.1fd420469f2042a1) — what Chunker converts, what it loses, and the
  full account of what "verified" means for a jar with no publisher signature.
- [Running the engine on this computer, or in a container](app-doc://article/material-bluemap.repository.5db9c82f867c7897) — the honest,
  five-state account of what happens when Docker itself cannot be used, local or remote.
- [Language modes and funny levels](app-doc://article/material-bluemap.repository.bfab28ebad332d8c) — why every download's explanation
