...
- &uarr; / &darr; move between revisions and stop at the ends rather than
  wrapping, Home / End jump to them, Enter or Space
  opens a revision, A and B choose the two comparison ends, Esc
...
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60) — the gate in front of trim.
- [Changelog and the in-app changelog viewer](app-doc://article/material-bluemap.repository.79fec962175325ca) — the date picker the
  history panel reuses.
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75) — the search field on
  the panel.
