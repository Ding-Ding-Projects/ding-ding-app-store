...
See [the parity audit](app-doc://article/material-bluemap.repository.d4e85ee67a6ba1bc).
...
- [Feature parity with BlueMapGUI](app-doc://article/material-bluemap.repository.d4e85ee67a6ba1bc) — the audit that named these four gaps
- [Language modes and funny levels](app-doc://article/material-bluemap.repository.bfab28ebad332d8c) — the voice-not-facts rule the update copy follows
- [Notification centre](app-doc://article/material-bluemap.repository.f44b3a9ab4be8af3) — where everything that only informs goes instead of the banner
- [Renders that survive being interrupted](app-doc://article/material-bluemap.repository.334128592026c1b2) — the other place a render in flight is protected
