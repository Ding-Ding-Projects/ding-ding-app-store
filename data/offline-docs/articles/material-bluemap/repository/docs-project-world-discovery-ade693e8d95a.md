...
reads the same world catalogue [Finding worlds](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9) documents and shows
...
- Nothing writes a project file just because a world was found. Clicking a row, or its
  **Use** button, or pressing Enter on it, opens the project editor **pre-filled
...
| Folders added, no worlds found | real folders exist and were read; they hold nothing | "No worlds were found. It looked in: \." |
...
Identical to [Finding worlds](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9#failure-modes-and-security): scanning is
...
- [Finding worlds](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9) - the catalogue and mount handling this panel
...
- [regex-builder.md](app-doc://article/material-bluemap.repository.6ff379945583bb75) - the builder this panel's search and its
  per-row context menu search both use
- [path-field.md](app-doc://article/material-bluemap.repository.cd0b3bff33b2bf22) - the browse button beside the mount field
- [super-confirmation.md](app-doc://article/material-bluemap.repository.d3717539aefc5d60) - why starting a project needs no gate
