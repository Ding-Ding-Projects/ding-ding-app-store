...
- [Local version history for config folders](app-doc://article/material-bluemap.repository.b950930a933f6a3e) — the history a saved mask
  already inherits.
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75) — the search-bar pattern
  a mask list's own search bar should follow once the drawing surface's shape list needs one.
- [Language modes and funny levels](app-doc://article/material-bluemap.repository.bfab28ebad332d8c) — the voice/facts split
