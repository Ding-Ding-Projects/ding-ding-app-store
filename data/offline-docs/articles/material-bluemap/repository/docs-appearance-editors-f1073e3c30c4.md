...
[super-confirmation gate](app-doc://article/material-bluemap.repository.d3717539aefc5d60), because it takes the settings every element
...
- [Tabbed navigation](app-doc://article/material-bluemap.repository.7bfd5537157accc8), which carries an opaque appearance record on every
  tab and group and never reads inside it.
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60), which stands in front of deleting a preset.
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75), which supplies the
