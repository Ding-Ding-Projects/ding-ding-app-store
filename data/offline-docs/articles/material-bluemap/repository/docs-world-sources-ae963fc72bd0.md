...
**A parts manifest**, which is what [large worlds](app-doc://article/material-bluemap.repository.5c9cca2da575c81d) describes and what this
...
- [Large worlds and rendered maps](app-doc://article/material-bluemap.repository.5c9cca2da575c81d) — the parts manifest this reads first, and how
  this project publishes one.
- [Rendering a world in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) — what happens to the world once it
  has arrived.
- [Rendering on a remote host](app-doc://article/material-bluemap.repository.3c1ea19ffb79c9bd) — the other way a world leaves this machine.
- [Worlds hosted on your own SSH server](app-doc://article/material-bluemap.repository.977fbd1bbf50c95b) — a world read from a machine
  you own, rather than published as a release.
- [Finding worlds](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9) — the worlds already on this computer.
