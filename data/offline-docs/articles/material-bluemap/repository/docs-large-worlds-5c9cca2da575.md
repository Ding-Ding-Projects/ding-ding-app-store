...
backup log use — see [Render console](app-doc://article/material-bluemap.repository.33011b9dbbe4fe25) for the full reasoning.
...
- [`docs/render-in-actions.md`](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) - rendering a world in CI, which is what
  produces the large maps this page exists to ship.
- `scripts/README.md` - the release-time scripts, including
