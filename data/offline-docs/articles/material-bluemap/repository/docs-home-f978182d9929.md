...
- [The command palette](app-doc://article/material-bluemap.repository.e8c7bcf1c71044a6), whose catalogue every capability card's copy and
  every opener's handler is drawn from.
- [Tabbed navigation](app-doc://article/material-bluemap.repository.7bfd5537157accc8), for the pinning, seeding and persistence mechanics
  Home's own tab relies on rather than reinventing.
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75), which backs Home's own
  search field exactly as it backs every other one in this application.
- [Language modes and funny levels](app-doc://article/material-bluemap.repository.bfab28ebad332d8c), for how Home's own prose - and every
