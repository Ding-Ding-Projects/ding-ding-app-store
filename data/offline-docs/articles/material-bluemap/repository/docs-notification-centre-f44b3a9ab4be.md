...
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75), which supplies this
  panel's search.
- [Changelog and the in-app changelog viewer](app-doc://article/material-bluemap.repository.79fec962175325ca), which supplies this panel's
  date range - the same anchored calendar, reused rather than rebuilt.
- [Local version history for config folders](app-doc://article/material-bluemap.repository.b950930a933f6a3e), whose own filter row -
  search, date range, action chips, all composing - this one was modelled on.
- [The command palette](app-doc://article/material-bluemap.repository.e8c7bcf1c71044a6), the other route to something whose name you know.
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60), for the opposite rule: what does block, and why.
