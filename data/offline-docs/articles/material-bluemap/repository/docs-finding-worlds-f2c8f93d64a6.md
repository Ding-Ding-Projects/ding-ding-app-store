...
- **Bedrock.** `%LOCALAPPDATA%\Packages\<PackageFamilyName>\LocalState\...` is Windows' own
  ...
  [Bedrock Edition worlds](app-doc://article/material-bluemap.repository.1fd420469f2042a1) names it as Bedrock rather than reporting a
...
is the default; regex is the explicit opt-in. See [regex-builder.md](app-doc://article/material-bluemap.repository.6ff379945583bb75).
...
- [Worlds ready to use on the Projects tab](app-doc://article/material-bluemap.repository.ade693e8d95a9fb3) - this same
...
- [regex-builder.md](app-doc://article/material-bluemap.repository.6ff379945583bb75) - the builder this list's search uses
- [path-field.md](app-doc://article/material-bluemap.repository.cd0b3bff33b2bf22) - the same browse button, wired into every other folder
  and file field in the application
- [Bedrock Edition worlds](app-doc://article/material-bluemap.repository.1fd420469f2042a1) - what happens once a Bedrock world reaches
  the detector this location's row feeds
- [legacy-1-12-worlds.md](app-doc://article/material-bluemap.repository.b43439f8929a964f) - what a 1.12.2 world can and cannot do
- [large-worlds.md](app-doc://article/material-bluemap.repository.5c9cca2da575c81d) - getting a world that is not on this machine yet
