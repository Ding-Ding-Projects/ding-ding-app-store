...
- [Publishing a rendered map to GitHub Pages](app-doc://article/material-bluemap.repository.9329e185bf79a100) — the address that
  keeps working after this computer is switched off.
- [Hosting a rendered map on your own server](app-doc://article/material-bluemap.repository.df6119822c5ddd1d) — the same
...
- [Running the engine on this computer, or in a container](app-doc://article/material-bluemap.repository.5db9c82f867c7897) — why a
  Docker render's output is exactly as reachable from this feature as a local render's.
- [Renders that survive being interrupted](app-doc://article/material-bluemap.repository.334128592026c1b2) — what "still writing
