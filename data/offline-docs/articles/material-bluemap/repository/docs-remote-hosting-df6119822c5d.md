...
[Publishing to GitHub Pages](app-doc://article/material-bluemap.repository.9329e185bf79a100) turns it into a real address somebody else hosts,
...
It reuses [rendering on a remote host](app-doc://article/material-bluemap.repository.3c1ea19ffb79c9bd)'s whole SSH/Docker foundation rather
...
[publishing to Pages](app-doc://article/material-bluemap.repository.9329e185bf79a100#the-fact-the-whole-feature-rests-on) relies on - so
...
the same honesty rule [`docker-and-local.md`](app-doc://article/material-bluemap.repository.5db9c82f867c7897) states for the local web
...
([`super-confirmation.md`](app-doc://article/material-bluemap.repository.d3717539aefc5d60)), naming exactly that cost before the action
