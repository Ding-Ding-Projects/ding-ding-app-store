...
[publishing to GitHub Pages](app-doc://article/material-bluemap.repository.9329e185bf79a100) already uses for its own marker. Before a
...
- [Rendering a world in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) — what the workflow this
  prepares actually does, once it can run.
- [Publishing a rendered map to GitHub Pages](app-doc://article/material-bluemap.repository.9329e185bf79a100) — the marker-file pattern
  this reuses, and the other place this project force-replaces a branch on purpose.
- [Scheduled re-rendering](app-doc://article/material-bluemap.repository.2e16c8f63b4747c4) — configuring the repository once a render
