...
[Running the engine on this computer, or in a container](app-doc://article/material-bluemap.repository.5db9c82f867c7897) for the raw
...
- [Running the engine on this computer, or in a container](app-doc://article/material-bluemap.repository.5db9c82f867c7897) for the
  pre-render novice dial this feature deliberately does not touch, and the raw `core.conf` fields
  it writes.
- [Render console](app-doc://article/material-bluemap.repository.33011b9dbbe4fe25) for the live log this panel sits beside.
- [Renders that survive being interrupted](app-doc://article/material-bluemap.repository.334128592026c1b2) for why a restart loses no tile
  already drawn.
- [Rendering a world in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) for why that route has no lever
  this control can reach.
- [Rendering on a remote host](app-doc://article/material-bluemap.repository.3c1ea19ffb79c9bd) for the SSH-over-Docker route this control does
