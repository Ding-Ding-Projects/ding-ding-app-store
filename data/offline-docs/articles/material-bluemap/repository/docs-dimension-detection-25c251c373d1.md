...
application: a search bar wired to the project's full [regex builder](app-doc://article/material-bluemap.repository.6ff379945583bb75)
...
corrupt Java world (see [Bedrock Edition worlds](app-doc://article/material-bluemap.repository.1fd420469f2042a1)). Dimension
...
- [Finding worlds](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9) - the step before this one: choosing which world
  folder to inspect in the first place.
- [The regex builder and the search bars it reaches](app-doc://article/material-bluemap.repository.6ff379945583bb75) - the builder
  this list's search bar uses.
- [Bedrock Edition worlds](app-doc://article/material-bluemap.repository.1fd420469f2042a1) - what a Bedrock world reports instead,
  and converting one to a Java world this feature can then read.
- [1.12.2 worlds](app-doc://article/material-bluemap.repository.b43439f8929a964f) - a world old enough to predate the modern
