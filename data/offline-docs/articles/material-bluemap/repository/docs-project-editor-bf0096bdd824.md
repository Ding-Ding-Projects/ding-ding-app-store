...
- [Browser-style tabbed navigation](app-doc://article/material-bluemap.repository.7bfd5537157accc8) for the layout and keyboard model the
  nested editor uses.
- [Worlds ready to use on the Projects tab](app-doc://article/material-bluemap.repository.ade693e8d95a9fb3) for the path that opens a
  discovered world in this editor.
- [Local version history for config folders](app-doc://article/material-bluemap.repository.b950930a933f6a3e) for the append-only history model
  shared by project saves.
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60) for the gate used when a map is removed.
