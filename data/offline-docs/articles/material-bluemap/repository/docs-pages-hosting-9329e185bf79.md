...
[Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60).
...
- [Rendering a world in GitHub Actions](app-doc://article/material-bluemap.repository.8be4992e8687fe6b) - the other route to a Pages
  copy, where the runners render and the merge job prepares the site.
- [Super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60) - the gate in front of taking a site down.
- [Large worlds and rendered maps](app-doc://article/material-bluemap.repository.5c9cca2da575c81d) - what to do when a map is past a limit.
