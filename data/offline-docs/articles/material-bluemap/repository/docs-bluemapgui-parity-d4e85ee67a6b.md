...
| Warn that a world folder is not a world | The World Path field validates live: directory must exist, and must contain `level.dat`, or `region/`, or a `dimensions/<ns>/<dim>/region/`. | **have** | `design/packages/app/src/main/world/inspect.ts` plus the whole discovery layer in `world/` — see [finding-worlds.md](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9). This project is far ahead here: it finds worlds rather than asking you to browse to them. | — |
...
| Colour pickers for sky and void | An HSV wheel with a hex field, six-digit, no alpha. | **have**, far ahead | The [appearance editors](app-doc://article/material-bluemap.repository.f1073e3c30c44e85) carry an infinite picker with a colour translator across many spaces. | Confirm the *map config* colour fields actually reach that picker rather than a plain text input. |
...
| A help link | Toolbar button opening the project's help page. | **partial** | There is a docs site and a [changelog viewer](app-doc://article/material-bluemap.repository.79fec962175325ca), and `github/external.ts` opens https URLs. Whether a Help affordance exists in the app chrome should be confirmed. | Tiny if missing. |
...
7. **Confirmation dialogs with a bare red text button.** This project has
   [super confirmation](app-doc://article/material-bluemap.repository.d3717539aefc5d60) for anything irreversible, and it exists
...
- World discovery. BlueMapGUI asks you to browse to a folder; this project finds worlds,
  ...
  ([finding-worlds.md](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9)).
...
- Rendering in GitHub Actions, sharded and resumable
  ([render-in-actions.md](app-doc://article/material-bluemap.repository.8be4992e8687fe6b), [resumable-renders.md](app-doc://article/material-bluemap.repository.334128592026c1b2)).
- Local git history over config folders ([config-history.md](app-doc://article/material-bluemap.repository.b950930a933f6a3e)), the
  [notification centre](app-doc://article/material-bluemap.repository.f44b3a9ab4be8af3), the [command palette](app-doc://article/material-bluemap.repository.e8c7bcf1c71044a6),
  [tabbed navigation](app-doc://article/material-bluemap.repository.7bfd5537157accc8), the [appearance editors](app-doc://article/material-bluemap.repository.f1073e3c30c44e85),
  the [regex builder](app-doc://article/material-bluemap.repository.6ff379945583bb75) on every search surface, and
  [language modes and funny levels](app-doc://article/material-bluemap.repository.bfab28ebad332d8c). BlueMapGUI has none of these; it
...
- [finding-worlds.md](app-doc://article/material-bluemap.repository.f2c8f93d64a6c4a9) - how this project finds worlds instead of asking
- [regex-builder.md](app-doc://article/material-bluemap.repository.6ff379945583bb75) - the search every new surface here has to carry
- [super-confirmation.md](app-doc://article/material-bluemap.repository.d3717539aefc5d60) - the gate a "delete rendered tiles" action belongs behind
- [language-and-tone.md](app-doc://article/material-bluemap.repository.bfab28ebad332d8c) - why annotated log advice can be funny and the quoted line cannot
