...
([regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1)), obeys the three language modes and both
tone sliders ([language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48)), and meets the
accessibility rules ([accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315)) — reachable and
...
| A destructive command executed straight from a row | The gate applies to every route, the palette included. See [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7). |
...
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the search the palette carries
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — the mockup's palette anatomy and the motion it specifies
- [appearance-customization.md](app-doc://article/material-designer.repository.196dde047df77cc4) — the settings the palette must index and be able to change inline
- [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7) — the gate every destructive row must route through
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — focus movement, announcement, and why a visual highlight alone is not a reveal
