...
[../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7#reading-a-run), which
...
| One article per feature | **Partial.** Several standards have gained their own article; the tree is still growing, and any standard without one is named in the [category index](app-doc://article/material-designer.repository.aa26f74331252403). |
| Every article stating behaviour, configuration, failure modes, security and verification | **Implemented** as the house convention — see [../README.md](app-doc://article/material-designer.repository.0b5ca119d2be595a) for the five-section floor. |
| Every article ending in suggested reading | **Implemented** as the house convention. |
| Status stated honestly per feature | **Implemented** as the house convention, with a defined status vocabulary in the [category index](app-doc://article/material-designer.repository.aa26f74331252403). |
...
| Changelog current with the build | **Tracked** — see [changelog-viewer.md](app-doc://article/material-designer.repository.e8f383ed5774d457), which also carries the requirement that the changelog is brought current per task rather than per release. |
...
- [../README.md](app-doc://article/material-designer.repository.0b5ca119d2be595a) — the house convention every article follows, and the five sections that are its floor
- [README.md](app-doc://article/material-designer.repository.aa26f74331252403) — the status vocabulary, and which standards still lack an article
- [changelog-viewer.md](app-doc://article/material-designer.repository.e8f383ed5774d457) — the changelog this standard keeps current, and the viewer that renders it
- [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the evidence rules for release claims, where an unverified claim is most costly
- [../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7) — the house-style reference, and the only anchored transcript in the repository
