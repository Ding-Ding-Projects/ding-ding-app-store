...
[notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) for the rule it is an exception to.
...
[language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48), applied where it matters most: a warning
...
| Bulk close tabs by text match | The strip's bulk-close actions — see [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) |
| Prune version history | The history panel — see [version-history.md](app-doc://article/material-designer.repository.6b9631cd4cb081da) |
| Reset all appearance customization | The appearance surface — see [appearance-customization.md](app-doc://article/material-designer.repository.196dde047df77cc4) |
| Delete a connected account or service | Settings |
| Any bulk action whose per-item form is destructive | Every list surface — see [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) |
...
- [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) — the non-blocking rule this is the deliberate exception to, and the undo that replaces the gate where an action is reversible
- [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) — the voice-not-facts rule, at the point where it matters most
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — keyboard operation, focus return, and why reduced motion must not weaken a safety control
- [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) — the preview and count the gate must be computed from
- [version-history.md](app-doc://article/material-designer.repository.6b9631cd4cb081da) — the undo that decides whether an action needs the gate at all
- [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) — bulk close, the most likely first destructive action to need it
