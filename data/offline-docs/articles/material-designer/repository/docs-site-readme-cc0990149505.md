...
| File | What it covers |
| --- | --- |
| [pages-deployment.md](app-doc://article/material-designer.repository.0cead755fa570184) | The `Pages` workflow: what it uploads, the self-contained-assets gate and what each of its six checks catches, the base-path trap that makes a green deployment 404, the installer-download-button rule, and how to verify a published site. |

## Why the site has its own category

The site is a **user-facing surface**, so every standard under
../standards/ binds it individually — the three language modes,
...
That is also why it does not live inside ../build/: the build
...
[../standards/README.md](app-doc://article/material-designer.repository.aa26f74331252403) requires.
...
- [pages-deployment.md](app-doc://article/material-designer.repository.0cead755fa570184) — the workflow and its publish-time gate
- ../build/ci.md — the other two workflows at the repository root
- [../standards/tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) — the tab requirements this surface implements and the two it records as inapplicable
- [../standards/releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the release whose installer the site's download button must point at
