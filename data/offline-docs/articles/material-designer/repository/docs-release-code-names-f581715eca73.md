...
- [release-assets.md](app-doc://article/material-designer.repository.9de3a56865765bee) — where the code-name image sits among the other attached files
- [release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — the step that calls this, and how the marker is read back
- [../standards/releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the code-name requirement as a standard, including the surfaces it is not yet on
