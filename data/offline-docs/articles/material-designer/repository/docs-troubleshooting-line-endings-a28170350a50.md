...
- [../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7) — the verifier in full: its two checks, its counters, its exit codes, and the allowlist contract
- [../porting/verbatim-import.md](app-doc://article/material-designer.repository.c0c56c3fa44ddb9c) — how the byte-for-byte copy was made, and the four ways a working-tree copy fails
- [../release/release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — the release job's guard step, and why it verifies before installing
- ../build/ci.md — why the fast gate runs on Linux
