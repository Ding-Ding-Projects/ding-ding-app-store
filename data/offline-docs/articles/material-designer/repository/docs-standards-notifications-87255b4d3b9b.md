...
voice-not-facts rule from [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48), applied where
it matters most.
...
What the mockup does specify — the notification and message-centre anatomy
...
- [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) — the voice-not-facts rule this standard depends on
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — focus, announcement and reduced motion
- [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) — bulk close, which is the most likely first destructive action to need the gate
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — anchored non-modal surfaces
