...
- **Composition with search and filter**, so "select everything matching this
  ...
  does everywhere else — see [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1).
...
- Use a blocking confirmation **only** for the destructive or irreversible ones —
  ...
  [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb), not a plain dialog.
...
uses — see [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b#requirement-5--local-version-history) — or
...
| Include-pinned in bulk close | Off | Pinned items are excluded by default; including them shows the protected items in the preview first. See [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748). |
...
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the pattern builder that "select everything matching" depends on
- [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) — the gate a destructive bulk action must pass, and the toast that reports a long one
- [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the local version history that makes a bulk action undoable
- [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) — bulk close containing / not containing text, the same rules applied to a tab strip
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — keyboard multi-select, and announcing a selection count to assistive technology
