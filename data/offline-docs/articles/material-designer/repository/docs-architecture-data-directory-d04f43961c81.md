...
- [daemon.md](app-doc://article/material-designer.repository.d2a69001b7e2ab97) — the process that performs the resolution, and the rest of its startup order
- [packaged-runtime.md](app-doc://article/material-designer.repository.224f711bf1d0aba7) — how the launcher resolves the namespace-scoped root before the daemon starts
- [../release/packaged-smoke-test.md](app-doc://article/material-designer.repository.3e55d384cd2c0acf) — the residue assertions that depend on this contract holding
- [../standards/releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the local version-history requirement, which snapshots what lives under this root
- [../troubleshooting/README.md](app-doc://article/material-designer.repository.654b42790a3dd7a7) — failures this project actually hit, written up so they are not rediscovered
