...
Step by step — from the line-ending guard to the published release
...
[../troubleshooting/line-endings.md](app-doc://article/material-designer.repository.a28170350a50b2c3).
...
[../troubleshooting/platform-specific-tests.md](app-doc://article/material-designer.repository.370b793c4229a601).
...
[packaged-smoke-test.md](app-doc://article/material-designer.repository.3e55d384cd2c0acf).
...
**14 — Count lines.** See [line-count.md](app-doc://article/material-designer.repository.beec80dda40f9cbc). The step keeps standard
...
**15 — Choose the code name.** See [code-names.md](app-doc://article/material-designer.repository.f581715eca73e36a).
...
| Symptom | Cause | Fix |
| --- | --- | --- |
| Verification fails with thousands of differing files | Line-ending conversion on checkout | The guard step exists for this. See [../troubleshooting/line-endings.md](app-doc://article/material-designer.repository.a28170350a50b2c3). |
| Verification exits `2` | No upstream reference, or a manifest that disagrees with the submodule | Exit `2` means "did not run", not "passed". See [../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7). |
...
| The same code name twice | The prior release's marker was missing or unreadable | See [code-names.md](app-doc://article/material-designer.repository.f581715eca73e36a). |
...
- [packaged-smoke-test.md](app-doc://article/material-designer.repository.3e55d384cd2c0acf) — what the test in step 12 actually proves, assertion by assertion
- [line-count.md](app-doc://article/material-designer.repository.beec80dda40f9cbc) — how the published figure is produced, and what its scopes mean
- [code-names.md](app-doc://article/material-designer.repository.f581715eca73e36a) — how a dish is chosen and why it is spent exactly once
- [release-assets.md](app-doc://article/material-designer.repository.9de3a56865765bee) — what each attached file is, and what is deliberately absent
- ../build/ci.md — the workflows as a set, including the fast gate this one deliberately does not depend on
- [../troubleshooting/README.md](app-doc://article/material-designer.repository.654b42790a3dd7a7) — the failures this pipeline actually hit on the way to working
