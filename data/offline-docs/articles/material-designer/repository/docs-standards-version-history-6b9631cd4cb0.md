...
- **A date picker** — the same advanced control the changelog viewer requires:
  ...
  user typed**. See [changelog-viewer.md](app-doc://article/material-designer.repository.e8f383ed5774d457).
...
passes the gate in [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7); export follows
the rules in [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27).
...
What the mockup specifies — and the two-sided gap between it and the product
...
- [changelog-viewer.md](app-doc://article/material-designer.repository.e8f383ed5774d457) — the advanced date control this panel reuses
- [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7) — the gate pruning and any destructive restore must pass
- [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) — the export rules, and the bulk actions this history makes undoable
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the search the panel carries
- [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — where this standard was first stated, beside the release machinery
