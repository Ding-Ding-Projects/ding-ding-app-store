...
builder ([regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1)), keyboard operation with visible
...
| Assets bundled locally | **Fonts met** in the application — Roboto Flex, Roboto Mono, Material Symbols Rounded and Cairo all ship as local assets and no CDN font import remains; see [typography-and-icons.md](app-doc://article/material-designer.repository.17d09285e6ab2598). The mockup still loads three font families from a third-party origin. The documentation site *is* fully bundled and its deployment enforces that at publish time. |
...
The 18-token handoff map — Material Design 3 role → existing interface variable
...
Component inventory — the 12 components the redesign changes, and what each becomes
...
Colour roles — 33 roles, four seeds, light and dark
...
Shape, motion and density scales — and the fact that most of them are declared but never used
...
Window chrome — the frameless title bar in full
...
Below the bar sit a 42px tab strip ([tabs.md](app-doc://article/material-designer.repository.da568c16710f2748)) and, at the bottom of the
...
The command palette — designed, and it meets the standard on paper
...
| Editing files under `design/` without a notice entry | Port verification fails the build. See [../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7). |
...
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — contrast, focus and scale, which this standard cannot be met without
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the search bar every appearance control carries
- [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) — the strip that sits directly below the title bar
- [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) — the non-modal surfaces this design depends on
- [../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7) — how to change a file under `design/` legitimately
