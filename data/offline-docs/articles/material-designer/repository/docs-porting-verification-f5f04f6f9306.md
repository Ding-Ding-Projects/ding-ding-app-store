...
The exact parser — the awk program that turns MODIFICATIONS.md into the allowlist
...
An earlier failing run, kept because a failure is more instructive than a pass
...
Seven observed allowlist states — undeclared edit, declared edit, stale notice, restored, missing file, untracked file, clean
...
Four observed source-of-truth states — manifest fallback, no reference at all, and both manifest-drift guards
...
- [verbatim-import.md](app-doc://article/material-designer.repository.c0c56c3fa44ddb9c) — how the copy was made in the first place
- ../build/ci.md — where this script is expected to run automatically
