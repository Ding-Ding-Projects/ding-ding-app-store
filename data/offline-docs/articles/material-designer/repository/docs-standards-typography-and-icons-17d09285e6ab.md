...
**Part of [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) (standard 2) and
[local-assets.md](app-doc://article/material-designer.repository.4be713d73b6329d4) (standard 15).** The Material Design 3
...
- **A font request is a disclosure.** Each one tells a third party the user's
  ...
  the files are on disk; see [local-assets.md](app-doc://article/material-designer.repository.4be713d73b6329d4).
...
- **A font family name is user input** once the appearance editor lands.
  ...
  here; both are recorded in [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354).
...
- [local-assets.md](app-doc://article/material-designer.repository.4be713d73b6329d4) — standard 15, the rule these files exist to satisfy
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — standard 2, which names these three faces
- [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) — why bilingual mode makes the CJK fallback load-bearing
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — the reduced-motion and contrast rules the symbol component obeys
- [../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7) — why every file above needed a `MODIFICATIONS.md` entry
- [../site/pages-deployment.md](app-doc://article/material-designer.repository.0cead755fa570184) — the publish-time gate the self-contained check now shares
