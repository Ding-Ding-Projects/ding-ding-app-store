...
in bilingual mode.** See [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) for the full
matrix and [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) for why bilingual is the case
that breaks first.
...
| Overlay | Owned by |
| --- | --- |
| The pattern builder anchored beside a search field | [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) |
| Context menus on tabs, groups, items and the application | [context-menu-shortcuts.md](app-doc://article/material-designer.repository.1760391787c55268) |
| The per-element **Edit appearance…** editor | [appearance-customization.md](app-doc://article/material-designer.repository.196dde047df77cc4) |
| The colour picker and its translator | [appearance-customization.md](app-doc://article/material-designer.repository.196dde047df77cc4) |
| The font family list | [appearance-customization.md](app-doc://article/material-designer.repository.196dde047df77cc4) |
| The tab overflow surface and the searchable tab list | [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) |
| The command palette in its bounded-card size | [command-palette.md](app-doc://article/material-designer.repository.1b5ac777c3383f4f) |
| The changelog and history date calendars | [changelog-viewer.md](app-doc://article/material-designer.repository.e8f383ed5774d457), [version-history.md](app-doc://article/material-designer.repository.6b9631cd4cb081da) |
| Notifications and the notification centre | [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) |
| The destructive-action gate, where it is anchored | [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7) |
...
- **A consent or confirmation surface must never be able to render off-screen or
  ...
  invisible — see [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7).
...
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — the clipping matrix these are validated against, and the focus rules on dismissal
- [appearance-customization.md](app-doc://article/material-designer.repository.196dde047df77cc4) — the anchored editor with the strictest anchoring requirement in the product
- [context-menu-shortcuts.md](app-doc://article/material-designer.repository.1760391787c55268) — the overlay this rule is most often broken in
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — the elevation, shape and surface roles an overlay paints itself with
- [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) — bilingual mode, where overlay width fails first
