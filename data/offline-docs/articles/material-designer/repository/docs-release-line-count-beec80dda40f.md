...
- [release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — the step that runs this, and what it does when it fails
- [release-assets.md](app-doc://article/material-designer.repository.9de3a56865765bee) — the rest of what a release carries
- [../standards/releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the requirement this satisfies, stated as a standard
- ../build/ci.md — the fast gate that also publishes a table, without attribution
