...
> repository-scoped Pages URL recorded in [README.md](app-doc://article/material-designer.repository.cc0990149505bbc8). The deployment
...
[../standards/releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b).
...
- [README.md](app-doc://article/material-designer.repository.cc0990149505bbc8) — what the site is built from, and the two standards it records as inapplicable
- ../build/ci.md — `Verify` and `Release`, the other two root workflows
- [../standards/material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — the token layer the site's CSS consumes
- [../standards/regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — why each search field owns its own builder instance
- [../standards/accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — the scale and width matrix the published page must hold at
