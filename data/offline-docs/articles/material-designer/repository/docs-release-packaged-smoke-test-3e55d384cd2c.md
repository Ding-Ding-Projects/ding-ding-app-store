...
[../architecture/data-directory.md](app-doc://article/material-designer.repository.d04f43961c819a58).
...
| --- | --- | --- |
| `settings-dialog.png` | The settings dialog, open | Ctrl+, dispatched at the window — the shortcut the app itself binds |
| `command-palette.png` | The command palette, open | Ctrl+Shift+F, likewise |
...
- [release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — where this step sits, and what happens either side of it
- [../architecture/packaged-runtime.md](app-doc://article/material-designer.repository.224f711bf1d0aba7) — what is being installed, and why its identity is asserted so carefully
- [../architecture/data-directory.md](app-doc://article/material-designer.repository.d04f43961c819a58) — the contract the residue checks depend on
- [release-assets.md](app-doc://article/material-designer.repository.9de3a56865765bee) — the artifact this test consumes, and what ships beside it
- [../troubleshooting/platform-specific-tests.md](app-doc://article/material-designer.repository.370b793c4229a601) — why this runs on Windows while most of the suite runs on Linux
