...
| `codename-<dish id>.png` | The release's dim sum code-name photograph, from the bundled catalogue. See [code-names.md](app-doc://article/material-designer.repository.f581715eca73e36a). |
...
See
[../troubleshooting/packaging-schema-drift.md](app-doc://article/material-designer.repository.6e3d1cf3d16a9100).
...
| The code-name image is missing | No dish was available, or its file was absent | Never blocks a release. See [code-names.md](app-doc://article/material-designer.repository.f581715eca73e36a). |
...
- [release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — the run that produces every one of these files
- [packaged-smoke-test.md](app-doc://article/material-designer.repository.3e55d384cd2c0acf) — the test the installer must pass before it is published
- [code-names.md](app-doc://article/material-designer.repository.f581715eca73e36a) — where the attached photograph comes from
- [../troubleshooting/packaging-schema-drift.md](app-doc://article/material-designer.repository.6e3d1cf3d16a9100) — the signing-adjacent property that fails the build on sight
