...
| **The site's publish-time gate** | **Implemented.** The deployment workflow enforces self-contained assets before publishing — see [../site/pages-deployment.md](app-doc://article/material-designer.repository.0cead755fa570184). |
...
[typography-and-icons.md](app-doc://article/material-designer.repository.17d09285e6ab2598).
...
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — the fonts and icon face this standard governs, and the token layer that consumes them
- [dim-sum-surprise.md](app-doc://article/material-designer.repository.3548ed3bf945f48d) — the most visible instance of the bundled-assets rule, and why its images are copied byte-for-byte
- [../site/pages-deployment.md](app-doc://article/material-designer.repository.0cead755fa570184) — the publish-time gate that enforces this on the documentation site
- [../architecture/overview.md](app-doc://article/material-designer.repository.e5a5102f18de6b16) — the local-first posture this standard exists to protect
