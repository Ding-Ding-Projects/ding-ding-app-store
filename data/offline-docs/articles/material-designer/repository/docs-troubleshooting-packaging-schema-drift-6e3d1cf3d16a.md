...
claiming none. See [../release/release-assets.md](app-doc://article/material-designer.repository.9de3a56865765bee) for
...
- [../release/release-assets.md](app-doc://article/material-designer.repository.9de3a56865765bee) — the unsigned-installer position, and what is deliberately absent from a release
- [../release/release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — the build step this failed in, and the existence check that guards its output
- [../architecture/packaged-runtime.md](app-doc://article/material-designer.repository.224f711bf1d0aba7) — the identity the installer writes, which *is* configured deliberately
