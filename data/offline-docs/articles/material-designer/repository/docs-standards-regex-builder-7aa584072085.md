...
The builder panel's contents — flags, token chips, live tester, and its four call sites
...
- [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) — the four tab-discovery searches, each of which needs its own builder
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — the appearance controls that each carry a search
- [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) — the builder's own copy is subject to the language modes too
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — keyboard operation and focus return
