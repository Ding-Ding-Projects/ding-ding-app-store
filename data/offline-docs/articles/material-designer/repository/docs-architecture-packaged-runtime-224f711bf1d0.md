...
| Data appears empty after an upgrade | A path derived from the app name, the user-data directory, a port, or the channel instead of the resolved data root | See [data-directory.md](app-doc://article/material-designer.repository.d04f43961c819a58). |
...
- [data-directory.md](app-doc://article/material-designer.repository.d04f43961c819a58) — the invariant the launcher resolves before anything else starts
- [desktop-shell.md](app-doc://article/material-designer.repository.bdd2e1ad8ecb5375) — the process the launcher hands off to
- [web-runtime.md](app-doc://article/material-designer.repository.1c2b5224cec132bc) — the sidecar the `od://` scheme proxies to
- [../release/packaged-smoke-test.md](app-doc://article/material-designer.repository.3e55d384cd2c0acf) — every assertion the observed run made
- [../release/release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — how the installer that gets tested is produced
