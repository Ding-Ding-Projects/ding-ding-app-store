...
- [release-pipeline.md](app-doc://article/material-designer.repository.2ff912fbf46a71c0) — the labelled build and publication sequence
- [release-assets.md](app-doc://article/material-designer.repository.9de3a56865765bee) — the exact files attached to a release
- [packaged-smoke-test.md](app-doc://article/material-designer.repository.3e55d384cd2c0acf) — what the Windows lifecycle smoke test proves
- [../architecture/packaged-runtime.md](app-doc://article/material-designer.repository.224f711bf1d0aba7) — the runtime boundaries behind the update cache
