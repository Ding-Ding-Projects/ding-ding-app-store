...
[regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1).
...
- **Filtering must not become authorization.** An item hidden by a search filter
  ...
  [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315).
- **A destructive item reachable from a context menu is a route like any other**,
  and routes through the gate in
  [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7). Its shortcut is a route too.
...
- [overlays.md](app-doc://article/material-designer.repository.a9331041c56b8fe1) — the surface, bounding and scrolling rules a menu must obey
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the builder each menu search is wired to
- [appearance-customization.md](app-doc://article/material-designer.repository.196dde047df77cc4) — **Edit appearance…**, the item that makes these menus long
- [tabs.md](app-doc://article/material-designer.repository.da568c16710f2748) — the tab and group menus with the largest item sets
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — announcement, keyboard reachability, and the rule that hiding is not refusing
