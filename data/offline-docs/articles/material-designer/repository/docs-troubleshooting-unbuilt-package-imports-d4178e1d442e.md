...
- [platform-specific-tests.md](app-doc://article/material-designer.repository.370b793c4229a601) — the failure that led to this job being created in the first place
- [test-timeouts.md](app-doc://article/material-designer.repository.cde6bd714cc07f94) — the next thing that went red, on the other platform
- [../architecture/desktop-shell.md](app-doc://article/material-designer.repository.bdd2e1ad8ecb5375) — the package whose built output is being imported
- ../build/from-source.md — the full local build order
