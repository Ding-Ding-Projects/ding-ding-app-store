...
> [!NOTE]
> This file owns standard 3. [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) owns
...
wired to the pattern builder — see [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1).
...
| Density | The middle step | The compact step is opt-in because it reduces hit-target size; see [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315). |
| Seed colour | The product's own default seed | Changing it regenerates the scheme rather than tinting a control. |
| Interface scale | 100% | The supported range and the clipping matrix are in [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315). |
...
| An anchored editor that detaches at a viewport edge | Specified as a failure: it must handle collision while staying visually attached. See [overlays.md](app-doc://article/material-designer.repository.a9331041c56b8fe1). |
...
- **Contrast is a safety property, not an aesthetic one.** A customization system
  ...
  moment it is chosen — see [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7).
...
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — the token layer, colour roles and scales this standard edits
- [overlays.md](app-doc://article/material-designer.repository.a9331041c56b8fe1) — the anchoring, surface-painting and viewport-bounding rules the editor must obey
- [context-menu-shortcuts.md](app-doc://article/material-designer.repository.1760391787c55268) — the menu **Edit appearance…** is reached from
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the search every appearance control carries
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — contrast, focus and the display-scale matrix, which this standard cannot be met without
