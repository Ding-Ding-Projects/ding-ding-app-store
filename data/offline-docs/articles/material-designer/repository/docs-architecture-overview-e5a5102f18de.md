...
> [daemon.md](app-doc://article/material-designer.repository.d2a69001b7e2ab97), [web-runtime.md](app-doc://article/material-designer.repository.1c2b5224cec132bc),
> [desktop-shell.md](app-doc://article/material-designer.repository.bdd2e1ad8ecb5375), [packaged-runtime.md](app-doc://article/material-designer.repository.224f711bf1d0aba7)
> and [data-directory.md](app-doc://article/material-designer.repository.d04f43961c819a58).
...
- **The HTTP surface.** 38 route files register 351 route handlers covering 304
  distinct path patterns. Grouped and listed in [../api/README.md](app-doc://article/material-designer.repository.ac0e4a04bf399f08).
...
Daemon dependency pins — the exact versions the vendored source declares

| Dependency | Version | Role |
| --- | --- | --- |
| Express | 5.2.1 | HTTP. Note: version 5 route wildcards are named (`*splat`), not bare `*`. |
| better-sqlite3 | 12.10.0 | Embedded database. No prebuilt binary for Windows on this runtime — see ../build/from-source.md. |
...
[../standards/language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48).
...
[../porting/verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7). The chrome decisions,
the two options deliberately rejected, and the one Windows 11 behaviour that does
not survive are in [desktop-shell.md](app-doc://article/material-designer.repository.bdd2e1ad8ecb5375).
...
All 37 subcommands — the complete dispatch map
...
| Native build toolchain | Required on Windows: the embedded database has no prebuilt binary for this platform/runtime pair and is compiled from source. See ../build/from-source.md. |
...
| Install fails compiling the database binding | Missing native build toolchain | See ../build/from-source.md. |
...
[../release/packaged-smoke-test.md](app-doc://article/material-designer.repository.3e55d384cd2c0acf) for exactly
...
- [daemon.md](app-doc://article/material-designer.repository.d2a69001b7e2ab97) — the stateful process, in detail
- [data-directory.md](app-doc://article/material-designer.repository.d04f43961c819a58) — the invariant every path in the product obeys
- [../api/README.md](app-doc://article/material-designer.repository.ac0e4a04bf399f08) — the daemon's HTTP surface in full
- ../build/from-source.md — the exact commands to make any of this run
- [../porting/verbatim-import.md](app-doc://article/material-designer.repository.c0c56c3fa44ddb9c) — why `design/` cannot be edited casually
- [../standards/material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — what the interface is being changed into
