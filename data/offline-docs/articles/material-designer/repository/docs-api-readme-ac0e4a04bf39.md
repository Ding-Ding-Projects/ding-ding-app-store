...
`postman/` — **368 requests in 28 folders**, derived
...
| File | Contents |
| --- | --- |
| `postman/material-designer-daemon.postman_collection.json` | The collection itself: Postman Collection v2.1.0, one folder per capability area, `{{baseUrl}}` as a collection variable, path parameters as Postman variables, and a JSON example body on every write request. |
| `postman/README.md` | How to import it, how to get a daemon to talk to, what each of the 28 folders covers, which of the 43 destructive requests to know about before clicking, the 17 streaming endpoints, and how to re-derive the route surface. |
...
Core, health and static — health, readiness, version, artifact and frame serving, the origin guard, the single-page fallback
...
Projects, files and conversations — the core workspace surface
...
Runs, chat and generated interface — driving the agent and streaming results
...
Design systems, skills, templates and static resources
...
Artifacts, media, library and memory
...
Import, export and host integration
...
Daemon control, metrics and telemetry
...
Credentials, connectors and external integrations
...
- ../../postman/README.md — the collection itself: importing it, its folders, its destructive and streaming requests, and its drift caveats
- [../architecture/overview.md](app-doc://article/material-designer.repository.e5a5102f18de6b16) — what serves this API and how it fits together
- ../build/from-source.md — how to get a daemon running to test against
- [../standards/releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the honesty rules that apply to documenting unverified things
