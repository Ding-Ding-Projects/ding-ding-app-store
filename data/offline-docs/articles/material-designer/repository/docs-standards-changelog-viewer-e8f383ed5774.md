...
and mode synchronise bidirectionally. See [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1).
...
the voice-not-facts rule, see [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48).
...
What the mockup specifies — and why it meets the standard on paper
...
it is the overlay rule from [overlays.md](app-doc://article/material-designer.repository.a9331041c56b8fe1) applied correctly, and a
...
- **An export crosses a trust boundary.** The exported file is plain text on
  ...
  [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27).
...
- [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — where releases and their notes come from, and the code name each entry carries
- [version-history.md](app-doc://article/material-designer.repository.6b9631cd4cb081da) — the panel that reuses this feature's date control
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the search this viewer carries
- [overlays.md](app-doc://article/material-designer.repository.a9331041c56b8fe1) — the calendar's surface, bounding and scrolling rules
- [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) — the export rules the copy and export actions follow
- [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) — tone applied to entries without altering facts
