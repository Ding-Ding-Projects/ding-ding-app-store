...
> `scripts/verify-port.sh`, not a transcript —
> anybody can re-run it and get the same answer regardless of how the bytes
> arrived. See [verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7).
...
The four failure modes of a naive copy-and-add — line-ending rewriting on read, line-ending rewriting on write, lost executable bits, and silently skipped ignored files
...
index. Its current output is quoted in [verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7): 11,799
...
- **Nothing from the vendored tree is installed or executed outside ephemeral
  ...
  See ../build/ci.md for why the confinement is deliberate.
...
[verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7).
...
- [verification.md](app-doc://article/material-designer.repository.f5f04f6f9306bda7) — the verifier, its counters, and its self-test
- [../architecture/overview.md](app-doc://article/material-designer.repository.e5a5102f18de6b16) — what the imported code actually is
- ../build/ci.md — why building is confined to continuous integration
