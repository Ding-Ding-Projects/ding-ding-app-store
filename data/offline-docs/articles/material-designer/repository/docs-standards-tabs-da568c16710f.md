...
and its translator ([material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354)).
...
What the mockup does specify — the strip's exact anatomy
...
See [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1).
...
- **Closing is destructive.** Unsaved-work protection applies per tab regardless
  ...
  gate applies — see [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb).
...
- [regex-builder.md](app-doc://article/material-designer.repository.7aa5840720857fb1) — the builder each of the four searches needs
- [material-design-3.md](app-doc://article/material-designer.repository.e990d57fb20c3354) — group and tab appearance editing
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — roles, roving focus, and the width and scale matrix
- [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) — the confirmation gate a large bulk close needs
- [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) — the count-and-preview and honest-exclusion rules the two bulk closes inherit
- [../site/README.md](app-doc://article/material-designer.repository.cc0990149505bbc8) — the one surface that records grouping and three of the four searches as inapplicable, and why
