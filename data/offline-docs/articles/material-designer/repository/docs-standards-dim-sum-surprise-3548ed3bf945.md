...
[local-assets.md](app-doc://article/material-designer.repository.4be713d73b6329d4). Each image carries **meaningful alt text
...
[notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) for the general rule against those.
...
| Images copied, never generated | **Implemented** by `scripts/import-dim-sum.sh`, which treats the source image manifest as the eligibility list, recomputes each file's checksum before copying, and skips and reports any dish that fails. See [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b#how-the-catalogue-is-produced). |
...
> [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b). That is why the catalogue landed first: one
...
- [releases.md](app-doc://article/material-designer.repository.b66a6fa7a6c7680b) — the release code name that reads the same catalogue, and how `scripts/import-dim-sum.sh` produces it
- [local-assets.md](app-doc://article/material-designer.repository.4be713d73b6329d4) — the bundled-assets rule this feature is the most visible instance of
- [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) — the non-blocking rules that make an un-optable surface acceptable
- [language-modes.md](app-doc://article/material-designer.repository.c18f6d2993c4fe48) — bilingual naming, and why the dish's name is a fact rather than copy
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — alt text, focus, and reduced motion
