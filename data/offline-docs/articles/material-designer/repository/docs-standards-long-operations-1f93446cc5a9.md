...
| Bulk actions over a large selection | Per-item work, see [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) |
...
- **A disabled control is a hint, not an authorization boundary.** Refusal
  ...
  [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7), applied to accident rather than
  intent.
...
- [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) — progress notifications for operations *not* started in a dialog, and how they resolve
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — live regions, focus, and why a disabled control is not a boundary
- [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) — bulk progress, cancellation and honest partial results
- [super-confirmation.md](app-doc://article/material-designer.repository.dac5d80fce58e4d7) — single-use authorization, the deliberate counterpart to accidental re-entry
- [overlays.md](app-doc://article/material-designer.repository.a9331041c56b8fe1) — keeping the dialog usable while it reports
