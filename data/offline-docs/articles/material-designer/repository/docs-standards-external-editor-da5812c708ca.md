...
One upstream detail worth keeping — an entry restricted to the platform where it actually works
...
[accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) on decorative-looking interface that must be
functional.
...
- [export-and-bulk-actions.md](app-doc://article/material-designer.repository.0cca043e3ec95f27) — the exports this hand-off must reach, and the formats they come in
- [notifications.md](app-doc://article/material-designer.repository.87255b4d3b9bddcb) — how a failed spawn is reported without halting the application
- [accessibility.md](app-doc://article/material-designer.repository.a93f9b3fba5c5315) — the rule against affordances that look functional and are not
- [../architecture/overview.md](app-doc://article/material-designer.repository.e5a5102f18de6b16) — the daemon that owns process spawning, and why the interface does not
- ../api/ — the daemon route surface this feature is exposed through
