...
- [Foundations](app-doc://article/opencodex.repository.c2506bea5703c3bd) — tokens, type scale, density
- [Components](app-doc://article/opencodex.repository.0eb07f889eca1a64) — the shared component inventory
- [Contributing](app-doc://article/opencodex.repository.3ec470ee87a36868) — how to add a surface without forking one
