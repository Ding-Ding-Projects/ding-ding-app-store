...
- [Maybe](https://searchfox.org/firefox-main/source/mfbt/Maybe.h#315) - Analogous to Rust `Option<>` or C++ std::optional (examples in [GTest](https://searchfox.org/firefox-main/source/mfbt/tests/TestMaybe.cpp)).
