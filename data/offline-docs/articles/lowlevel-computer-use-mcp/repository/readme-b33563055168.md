...
[`docs/features`](app-doc://article/lowlevel-computer-use-mcp.repository.e7e392e08738485b).
...
*Image omitted from the offline bundle: Electron Workspaces showing named headless desktop controls.*

*Image omitted from the offline bundle: Electron Tool runner showing file transfer and path controls.*

*Image omitted from the offline bundle: Electron file transfer card.*

*Image omitted from the offline bundle: Electron History showing date and action filters.*

*Image omitted from the offline bundle: Electron Settings showing language, funny-level, and appearance controls.*

*Image omitted from the offline bundle: Electron appearance translator showing color-space conversion.*

*Image omitted from the offline bundle: Electron Tab manager showing groups and reviewable bulk close.*

*Image omitted from the offline bundle: Electron Memory page showing local checkpoint controls.*

*Image omitted from the offline bundle: Electron Changelog showing date filtering, regex search, and commit evidence.*
...
plus `SW_HIDE`. See
[runtime safety](app-doc://article/lowlevel-computer-use-mcp.repository.9d85fd2c1b087deb).
...
are never persisted or transmitted. See [regex builder documentation](app-doc://article/lowlevel-computer-use-mcp.repository.1ef67a9491ffe809).
