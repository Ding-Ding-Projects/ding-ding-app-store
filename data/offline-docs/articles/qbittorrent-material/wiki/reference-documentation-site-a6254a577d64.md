...
This includes the complete [Custom Workspace Tabs](app-doc://article/qbittorrent-material.wiki.2a987b0b73b6c688) reference
and its shorter task-oriented Wiki guide. The
Windows Desktop Features index links one article per
