...
See the [Workspace Tabs wiki guide](app-doc://article/qbittorrent-material.wiki.0ca7ea19e5bae8a4) for the short
task-oriented walkthrough and [Troubleshooting](app-doc://article/qbittorrent-material.wiki.0278323fb6071d70) for
recovery guidance.

For feature-level behavior, failure modes, privacy, and verification, see
Tab management and discovery,
Search and regex builder, and
Runtime appearance.
