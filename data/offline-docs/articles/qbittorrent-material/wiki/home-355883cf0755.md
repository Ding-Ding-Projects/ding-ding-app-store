...
- [Getting started](app-doc://article/qbittorrent-material.wiki.e6407ccc6d558d0e) — install a release, build locally, and launch the app.
- [Interface tour](app-doc://article/qbittorrent-material.wiki.7304288860ab4428) — learn the navigation, filters, transfer table, properties, and status areas.
- [Windows desktop features](app-doc://article/qbittorrent-material.wiki.740de197f1947ff8) — review language, notifications, dim sum, changelog, tab discovery, appearance, history, editors, and delivery.
- [Workspace tabs](app-doc://article/qbittorrent-material.wiki.0ca7ea19e5bae8a4) — create persistent pages, customize typography, and move snapshots or complete local Git history.
- [Search, filters, and portability](app-doc://article/qbittorrent-material.wiki.6f33e160ab116d88) — use regex search, the filter builder, and JSON/Markdown import and export.
- [Releases and automation](app-doc://article/qbittorrent-material.wiki.0558691a66bc6a7a) — understand the installer pipeline and per-push releases.
- [Architecture](app-doc://article/qbittorrent-material.wiki.ee350d8983cecfa1) — explore the engine, controller, model, and QML boundaries.
- [Troubleshooting](app-doc://article/qbittorrent-material.wiki.0278323fb6071d70) — solve common build, packaging, launch, and documentation issues.
- [Contributing](app-doc://article/qbittorrent-material.wiki.1246fcebc419eba2) — keep code, visuals, and docs consistent.
