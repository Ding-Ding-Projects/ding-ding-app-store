...
remain tracked in [`docs/FEATURE_SPEC.md`](app-doc://article/qbittorrent-material.repository.dc0e817dee8ad163).

Cross-app experience, Workspace, appearance, and delivery behavior is indexed
in [`docs/features/README.md`](app-doc://article/qbittorrent-material.repository.e7e392e08738485b), with one factual article
...
See [Transfer-list export](app-doc://article/qbittorrent-material.repository.09dda5565ab59c3b).
...
[Experience feature index](app-doc://article/qbittorrent-material.repository.bbfdb36524e4ef2f) and
...
See [Custom Workspace Tabs](app-doc://article/qbittorrent-material.repository.fbd1f1e6406d8768),
[Tab management and discovery](app-doc://article/qbittorrent-material.repository.bd88ce1de7b72f2c), and
...
See [`docs/PAGES.md`](app-doc://article/qbittorrent-material.repository.e47ae83ea90b4cee) for local preview, content generation,
publishing, and Wiki synchronization.

*Image omitted from the offline bundle: qBittorrent Material documentation landing page.*

| Embedded wiki search | Regex builder |
| --- | --- |
| *Image omitted from the offline bundle: Embedded documentation search.* | *Image omitted from the offline bundle: Regex search builder.* |

*Image omitted from the offline bundle: Responsive mobile documentation.*
...
[`docs/SCREENSHOTS.md`](app-doc://article/qbittorrent-material.repository.eab79d625b126e5d). Captures `14`–`17` exercise
...
*Image omitted from the offline bundle: Light Transfers workspace in the complete qBittorrent Material shell.*

| Dark Transfers workspace | Compact desktop shell |
| --- | --- |
| *Image omitted from the offline bundle: Dark theme Transfers workspace.* | *Image omitted from the offline bundle: Compact 960px Transfers layout.* |

| Transfer table | Dark torrent properties |
| --- | --- |
| *Image omitted from the offline bundle: Transfers table and filters.* | *Image omitted from the offline bundle: Dark Transfers properties panel.* |

| Execution Log | Search |
| --- | --- |
| *Image omitted from the offline bundle: Execution Log workspace.* | *Image omitted from the offline bundle: Dark Search workspace.* |

| RSS | Personal Workspace |
| --- | --- |
| *Image omitted from the offline bundle: RSS reader workspace.* | *Image omitted from the offline bundle: Persistent personal Workspace.* |
...
| --- | --- |
| *Image omitted from the offline bundle: Download from URLs dialog.* | *Image omitted from the offline bundle: About qBittorrent dialog in Dark mode.* |
...
See [`docs/BUILDING.md`](app-doc://article/qbittorrent-material.repository.e3578d08ce0aa271) for prerequisites, manual CMake
...
See [Immutable Windows Releases](app-doc://article/qbittorrent-material.repository.c44d3791ddf0563f) for
...
Summary of the shared rules that govern changes to this repository

The full sanitized text lives in AGENTS.md. In outline:
