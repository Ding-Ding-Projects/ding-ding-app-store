...
The **Customize** page records image intent in eight sections. Each successful edit is saved and committed before it can become a servicing operation. Use [Review and Run](app-doc://article/wimforge.wiki.e374c4ff9f62b284) to inspect the resulting executable, arguments, dependencies, and risk flags.
...
An answer-file path here becomes servicing input. Use [Unattended Studio](app-doc://article/wimforge.wiki.cc2bc1251e33b348) for profile editing and XML export, then validate the XML in Windows SIM against the exact image/catalog.

Post-setup work crosses from offline image construction into code that runs during setup or first logon. Review every executable and argument, keep secrets out of project state, and test both connected and offline network conditions. For the structured, resumable software path, prefer [Package Studio](app-doc://article/wimforge.wiki.508f934e25d36a4e). For typed WinForge-family actions, use [WinForge Bridge](app-doc://article/wimforge.wiki.756d93d5550cf500).
...
[← Projects and Sources](app-doc://article/wimforge.wiki.39b1fe5a4ab59a3f) · [Image Servicing →](app-doc://article/wimforge.wiki.94e35c5f9f6ce990)
