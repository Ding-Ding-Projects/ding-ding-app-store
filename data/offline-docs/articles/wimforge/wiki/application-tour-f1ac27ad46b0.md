...
| --- | --- | --- |
| **Overview** | See the current project, operation/history counts, running jobs, build flow, safety reminders, and current job progress. | [Getting Started](app-doc://article/wimforge.wiki.e6407ccc6d558d0e) |
| **Source & editions** | Select and inspect media, choose the working image/index, keep cloning enabled, and select an output. | [Projects and Sources](app-doc://article/wimforge.wiki.39b1fe5a4ab59a3f) |
| **Customize** | Queue update, driver, feature, Appx, component, setting, answer-file, and post-setup intent. | [Customize](app-doc://article/wimforge.wiki.6fc98d84b89d732e) |
| **Group Policy Studio** | Load installed ADMX/ADML definitions, search them, edit schema-backed values, and commit registry policy state. | [Group Policy Studio](app-doc://article/wimforge.wiki.f508babdfefafc0e) |
| **Unattended Studio** | Build or import a portable profile and export Windows answer-file XML. | [Unattended Studio](app-doc://article/wimforge.wiki.cc2bc1251e33b348) |
| **Package Studio** | Select first-logon software, validate provider/trust metadata, and stage a resumable bundle. | [Package Studio](app-doc://article/wimforge.wiki.508f934e25d36a4e) |
| **WinForge Bridge** | Review typed actions, detect a runtime contract, and stage a verified OEM payload. | [WinForge Bridge](app-doc://article/wimforge.wiki.756d93d5550cf500) |
| **Virtual Machine Lab** | Discover installed VMware/VirtualBox providers, create or load VMs, review lifecycle and device operations, manage snapshots, and retain validation evidence. | [Virtual Machine Lab](app-doc://article/wimforge.wiki.076d6cb735ffb0f4) |
| **Review & run** | Inspect commands, dependencies, risk markers, elevation, checkpoints, and execution state. | [Review and Run](app-doc://article/wimforge.wiki.e374c4ff9f62b284) |
| **History & recovery** | Selectively undo/redo project intent, inspect commits/diffs, and review notification history. | [History Time Machine](app-doc://article/wimforge.wiki.6eee581e6e437124) |
| **Settings** | Choose language/theme, job limits, failsafes, project automation, and inspect notification storage. | [Settings](app-doc://article/wimforge.wiki.d3dd65b6f7bde0e5) |
| **Embedded terminal** | Run an explicitly started elevated PowerShell or Command Prompt session through ConPTY with bounded in-app output and no external console. | [Embedded Terminal](app-doc://article/wimforge.wiki.f07006442132f0f4) |
...
Undo appends compensating history; it does not rewrite the past or reverse external bytes already committed by DISM or an installer. See [History Time Machine](app-doc://article/wimforge.wiki.6eee581e6e437124) and [Safety and Recovery](app-doc://article/wimforge.wiki.a57c84860be90dc5).
...
The current checked-in image gallery is on [Screenshots](app-doc://article/wimforge.wiki.221c82517fc21edc).
...
[← Getting Started](app-doc://article/wimforge.wiki.e6407ccc6d558d0e) · [Projects and Sources →](app-doc://article/wimforge.wiki.39b1fe5a4ab59a3f)
