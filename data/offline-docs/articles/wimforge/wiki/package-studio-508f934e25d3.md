...
The profile orders Git before Claude Code, Node before npm-based AI clients, and build-system dependencies before consumers. The committed `templates/ai-development.json` is the exact portable profile.
...
Implementation detail lives in `docs/package-studio.md`.
...
[← Image Servicing](app-doc://article/wimforge.wiki.94e35c5f9f6ce990) · [Group Policy Studio →](app-doc://article/wimforge.wiki.f508babdfefafc0e)
