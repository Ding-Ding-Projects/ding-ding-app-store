...
JSON is configuration interchange only. A [Project Bundle](app-doc://article/wimforge.wiki.6fb52219fd512f87) carries the complete project tree—including hardened nested workspace-tab history—and the notification repository, including Git objects and undo history.
...
WimForge builds output into project-owned work paths and promotes validated final files rather than presenting a partial file as complete. Output planning, split-image behavior, media staging, and ISO ordering are described in [Image Servicing](app-doc://article/wimforge.wiki.94e35c5f9f6ce990).
...
Then continue to [Customize](app-doc://article/wimforge.wiki.6fc98d84b89d732e). Before execution, review [Safety and Recovery](app-doc://article/wimforge.wiki.a57c84860be90dc5).
...
[← Application Tour](app-doc://article/wimforge.wiki.f1ac27ad46b00247) · [Customize →](app-doc://article/wimforge.wiki.6fc98d84b89d732e)
