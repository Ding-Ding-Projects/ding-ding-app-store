...
Undo appends a compensating action. It does not erase history or prove that external side effects were reversed. A complete [Project Bundle](app-doc://article/wimforge.wiki.6fb52219fd512f87) carries the project tree, nested workspace-tab history, and notification repository together.
...
Track repository claims against current tests and the [NTLite Feature Comparison](app-doc://article/wimforge.wiki.b5467afd2a738b1e), not against planned UI labels.

Implementation references: `CMakeLists.txt`, `src/AppController.h`, `docs/servicing-plan.md`, and `docs/context-history.md`.
...
[← Troubleshooting](app-doc://article/wimforge.wiki.0278323fb6071d70) · [Building and Releases →](app-doc://article/wimforge.wiki.406b23d821d80476)
