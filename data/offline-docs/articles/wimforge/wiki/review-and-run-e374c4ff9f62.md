...
A project must be open, the plan must be nonempty, and no other run may be active. Destructive CLI apply also requires `--yes`; see [Command-Line Interface](app-doc://article/wimforge.wiki.851cf7549f772497).
...
After an interruption, WimForge can rebuild the plan, undo the latest configuration change, or—only under guarded elevated conditions—discard the exact mount recorded in the journal. Read [Safety and Recovery](app-doc://article/wimforge.wiki.a57c84860be90dc5) before using recovery actions.
...
- [ ] A complete [Project Bundle](app-doc://article/wimforge.wiki.6fb52219fd512f87) exists.
- [ ] A disposable-VM installation test is planned.

---

[← Image Servicing](app-doc://article/wimforge.wiki.94e35c5f9f6ce990) · [History Time Machine →](app-doc://article/wimforge.wiki.6eee581e6e437124)
