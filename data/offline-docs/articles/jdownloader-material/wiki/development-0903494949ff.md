...
[UI smoke handoff](app-doc://article/jdownloader-material.repository.d80ab157289480e9)
...
Open `http://localhost:8000/` and verify the overview and interactive demo. See [Releases](app-doc://article/jdownloader-material.wiki.0558691a66bc6a7a) for the `main`-only publication flow.
