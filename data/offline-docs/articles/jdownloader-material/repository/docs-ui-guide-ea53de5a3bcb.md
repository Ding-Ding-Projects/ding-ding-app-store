...
Ctrl+Shift+A for the focused element. Workspace structure and
...
| --- | --- | --- |
| *Image omitted from the offline bundle: Downloads with fixed activity feedback.* | *Image omitted from the offline bundle: Queued item properties in the light theme.* | *Image omitted from the offline bundle: Queued item properties in the dark theme.* |
...
| --- | --- | --- |
| *Image omitted from the offline bundle: LinkGrabber light.* | *Image omitted from the offline bundle: LinkGrabber dark.* | *Image omitted from the offline bundle: LinkGrabber in playful Hong Kong Cantonese.* |
...
model, and leaves files on disk alone. See [History Manager](app-doc://article/jdownloader-material.repository.03357ad51eea15a5).
...
| --- | --- |
| *Image omitted from the offline bundle: Settings general section in the light theme.* | *Image omitted from the offline bundle: Settings general section in the dark theme.* |

| Appearance, light | Appearance, dark | Appearance, bilingual |
| --- | --- | --- |
| *Image omitted from the offline bundle: Appearance settings in the light theme.* | *Image omitted from the offline bundle: Appearance settings in the dark theme.* | *Image omitted from the offline bundle: Appearance settings in bilingual English and Hong Kong Cantonese.* |
...
| Light | Dark | Bilingual English / Hong Kong Cantonese |
| --- | --- | --- |
| *Image omitted from the offline bundle: Add Links drawer in the light theme.* | *Image omitted from the offline bundle: Add Links drawer in the dark theme.* | *Image omitted from the offline bundle: Add Links drawer in bilingual English and Hong Kong Cantonese.* |
...
| --- | --- | --- |
| *Image omitted from the offline bundle: Downloads in playful Hong Kong Cantonese.* | *Image omitted from the offline bundle: Downloads in bilingual English and Hong Kong Cantonese.* | *Image omitted from the offline bundle: Downloads at 880 by 560 pixels in bilingual mode.* |
...
| --- | --- | --- |
| *Image omitted from the offline bundle: Searchable changelog with date filters, copy, and export.* | *Image omitted from the offline bundle: Searchable notification history in bilingual mode.* | *Image omitted from the offline bundle: Non-blocking shrimp-dumpling startup card over Downloads.* |
...
*Image omitted from the offline bundle: Strict-loopback installed-JDownloader plugins bridge.*
...
[UI smoke handoff](app-doc://article/jdownloader-material.repository.d80ab157289480e9) records the route, accessibility, and clipping checks that accompany
the gallery.
