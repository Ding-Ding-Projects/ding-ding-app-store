...
Install dependencies with `npm ci`, then use `npm run dev` for development. The complete local documentation site is available at `site/index.html`. Hosted site placeholder: **not published yet**.

## Contents

- [Documentation index](app-doc://article/material-email.repository.0b5ca119d2be595a)
- [LibreOffice source-reference map](app-doc://article/material-email.repository.194bb6b8ca62fc4b)
- Roadmap
- Current handoff
...
Read [Security boundaries](app-doc://article/material-email.repository.a289162538858932) for the threat model and verification limits.
...
> This is a public, project-scoped mirror of shared contributor rules. It contains only portable, public-safe requirements. Update the canonical instructions first, then refresh this mirror and `AGENTS.md`.
...
The complete operational mirror is in `AGENTS.md`.
