...
The mail field sends valid plain/regex queries through the desktop bridge to an ephemeral [bounded cached-mail index](app-doc://article/material-email.repository.acd9c4d9663c4f3d). It searches capped summary/body-snippet fields across cached accounts and returns account/folder/conversation attribution. Other search surfaces retain their documented local collection behavior.
...
- [Tabs and discovery](app-doc://article/material-email.repository.7ed9f457d4e19ee6)
- [Local state and history](app-doc://article/material-email.repository.458399858adbe8c0)
- [Changelog](app-doc://article/material-email.repository.b803c2ec8569bdcf)
