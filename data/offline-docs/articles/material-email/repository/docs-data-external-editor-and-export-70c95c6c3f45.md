...
History, settings, changelog, and regex content can be saved through native dialogs. Cancellation returns without writing. Attachment export has its own native-dialog and collision-handling paths described in [Reading and message safety](app-doc://article/material-email.repository.5d1bee4eeb3843ef).
...
- [Development and packaging](app-doc://article/material-email.repository.780f8b7ab61c95cc)
- [Security boundaries](app-doc://article/material-email.repository.a289162538858932)
