...
*Image omitted from the offline bundle: The four known submodule states from declaration through an updated pinned checkout.*
...
*Image omitted from the offline bundle: A big toy box holding toys and a smaller labelled toy box.*
...
*Image omitted from the offline bundle: The parent project's bookmark points at exactly version 3 on a shelf of versions.*
...
*Image omitted from the offline bundle: A clone list row with a number badge opening a submodule details card.*
...
*Image omitted from the offline bundle: The small box lifted out of the big box, standing on its own shelf.*
...
*Image omitted from the offline bundle: The Submodule Manager with search, status chips, and per-row buttons.*
...
- **A search box** that matches names, paths, or URLs. It has the same substring/regex
  powers as every other search — see the [Regex Guide](app-doc://article/desktop-material.wiki.5ca9bc45a79f3aeb).
...
*Image omitted from the offline bundle: An initialized submodule opened temporarily with a context bar and Back control to the persisted root repository.*
...
*Image omitted from the offline bundle: A luggage tag with the old address crossed out and a new one written in.*
...
*Image omitted from the offline bundle: Clone-style Add Submodule review with a source, checkout path, and tracked branch.*
...
*Image omitted from the offline bundle: Three panels: the box arrives, gets its name tag, then is filled with the right toys.*
...
*Image omitted from the offline bundle: A submodule stays a labelled box; a subtree pours the toys into the big box.*
...
**See also:** [User Guide](app-doc://article/desktop-material.wiki.9a566c302cfe9bfb) · [Guided Feature Gallery](app-doc://article/desktop-material.wiki.9f2c0c89337f30db) · [Regex Guide](app-doc://article/desktop-material.wiki.5ca9bc45a79f3aeb)
