...
*Image omitted from the offline bundle: Automation moving from a scheduled trigger through repository checks to a bounded action and audit trail.*

*Image omitted from the offline bundle: A conceptual automation pipeline with trigger, safety gate, decision, controlled actions, and history.*
