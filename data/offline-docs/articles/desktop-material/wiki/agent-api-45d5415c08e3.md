...
*Image omitted from the offline bundle: The local agent request path through authentication, validation, exact repository resolution, and app safeguards.*
...
`AppStore` (see the [Developer Guide](app-doc://article/desktop-material.wiki.08e927aab695accc)) so agent-initiated actions obey the same
...
Where the app already gates an action (for example the [Automation](app-doc://article/desktop-material.wiki.81fc87a3020bb04a) preconditions), the
...
**See also:** [Developer Guide](app-doc://article/desktop-material.wiki.08e927aab695accc) · [Automation](app-doc://article/desktop-material.wiki.81fc87a3020bb04a)
