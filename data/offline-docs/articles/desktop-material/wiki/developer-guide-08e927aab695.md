...
See [No-op renderer update suppression](app-doc://article/desktop-material.repository.1ad40193212b970c)
...
See [Root renderer resource lifecycle](app-doc://article/desktop-material.repository.972057bebe3ff833)
for behavior, failure modes, security boundaries, and verification evidence.

*Image omitted from the offline bundle: The renderer state path from React UI through Dispatcher and AppStore to a fresh state.*
...
> **The design contract is `MATERIAL_REDESIGN.md` at the repo root.**
...
*Image omitted from the offline bundle: Two isolated account lanes connecting only to their matching repositories and remotes.*
...
See [Agent API](app-doc://article/desktop-material.wiki.45d5415c08e37aab) for connection steps, command names, and the security model.
...
The [Guided Feature Gallery](app-doc://article/desktop-material.wiki.9f2c0c89337f30db) is the machine-checked
...
The Build & Run dispatcher owns the provider-neutral lifecycle and the main
process owns separate typed IPC handlers for Codex and OpenCode. Codex detection
...
**See also:** [Agent API](app-doc://article/desktop-material.wiki.45d5415c08e37aab) · [Automation](app-doc://article/desktop-material.wiki.81fc87a3020bb04a) · [User Guide](app-doc://article/desktop-material.wiki.9a566c302cfe9bfb)
