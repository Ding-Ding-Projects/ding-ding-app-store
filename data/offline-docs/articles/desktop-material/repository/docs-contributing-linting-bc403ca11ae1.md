...
Most (if not all) editors have integrations for these tools so that they will report errors and fix formatting in realtime. See [tooling](app-doc://article/desktop-material.repository.96a2a250017fa2f7) for how to set these integrations up while developing for desktop.
