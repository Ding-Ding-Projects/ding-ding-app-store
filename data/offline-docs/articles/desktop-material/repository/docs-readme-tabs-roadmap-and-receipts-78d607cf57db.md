...
`ROADMAP.md`. The July 22 feature continuation is published at
...
corrected acceptance receipt remains in `HANDOFF.md`.
...
synthetic-only captures appear in the [Screenshots](app-doc://article/desktop-material.repository.5427e8e90f762374) tab. The implementation ledger is in
`PLAN.md`, with exact publication evidence in
`HANDOFF.md`.

The M20 platform wave and earlier post-M19 adaptive customization maintenance
release described in the [Features](app-doc://article/desktop-material.repository.d2e40a408df25474) tab are shipped on `main`. Their exact production build,
...
`HANDOFF.md`; the existing M0–M19 receipts remain historical
...
and acceptance rules live in `ROADMAP.md`. Detailed implementation
and verification receipts remain in `PLAN.md` and
`HANDOFF.md`.
