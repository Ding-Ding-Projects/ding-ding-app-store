...
([see tab search](app-doc://article/material-winscp.repository.fddab57862530c8d)). Pinned tabs stay visible when ordinary tabs
overflow.
...
- They are **excluded by default** from close-others, close-to-the-right and
  [text-based bulk closes](app-doc://article/material-winscp.repository.d13fd8e778625923). Including them is an explicit choice
...
- [Tab groups](app-doc://article/material-winscp.repository.dcfc7e059c2bc2ec) — organizing a large strip.
- [Tab search](app-doc://article/material-winscp.repository.fddab57862530c8d) — finding a tab in the overflow.
- [Bulk close](app-doc://article/material-winscp.repository.d13fd8e778625923) — and the pinned-protection rule.
- [Tab appearance](app-doc://article/material-winscp.repository.b0a933757c6fef67) — restyling individual tabs.
