...
| Check/uncheck all | The toolbar and its context menu tick every actionable row or clear every row. `Do nothing` rows remain unticked. Keyboard users can use Ctrl/⌘+A to check all and Ctrl/⌘+Shift+A to uncheck all. Shortcuts do not intercept typing in controls. |
...
- [Synchronize](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac) — what produces this list.
- [Keep remote directory up to date](app-doc://article/material-winscp.repository.04b191ece9141ae0) — the continuous mode.
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — the builder anchored to this search bar.
- Tabs and navigation — the checklist is a tab, with everything that implies.
