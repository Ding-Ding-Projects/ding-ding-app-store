...
- [The adapter contract](app-doc://article/material-winscp.repository.77c1e7f43ee4268a) — the interface this implements, and the POSIX assumption it exists to preserve.
- Synchronization — where local and remote listings meet.
- Version history — why the history repository lives where it does.
- [Editors](app-doc://article/material-winscp.repository.29bfa1ddbd07f338) — what the temporary directory is for.
