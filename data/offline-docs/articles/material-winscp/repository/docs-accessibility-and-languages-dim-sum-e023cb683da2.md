...
[release code names](app-doc://article/material-winscp.repository.ec20b3572803cd00). A record whose image
...
- [Language modes](app-doc://article/material-winscp.repository.728997f194376526) — the dish name in both languages.
- [Funny levels](app-doc://article/material-winscp.repository.8dd415c0d17db8b3) — which styles the copy but never the dish name.
- [Releases](app-doc://article/material-winscp.repository.ec20b3572803cd00) — the same catalog supplies release code names.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — the non-blocking surface rules.
