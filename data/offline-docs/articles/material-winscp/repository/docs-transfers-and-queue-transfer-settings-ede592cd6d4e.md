...
| Option | Default | Meaning |
| --- | --- | --- |
| `includeFileMask` | `''` | The [file mask](app-doc://article/material-winscp.repository.a3cb68eed237457c) filtering the transfer. |
...
| Option | Default | Meaning |
| --- | --- | --- |
| `cpsLimit` | `0` | Bytes per second, `0` = unlimited. See [speed limits](app-doc://article/material-winscp.repository.22b4cd406df4a5ee). |
...
| `resumeSupport`, `resumeThreshold`, `partialFileExt`, `overwriteMode` | see [resume](app-doc://article/material-winscp.repository.aab408eda60c69e6) | The first three are editable in the shared transfer-settings frame; `overwriteMode` controls the existing-target decision. |
...
version history: deleting one by mistake is undoable.
...
- [The queue](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889) — where a settings snapshot is taken.
- [Resume](app-doc://article/material-winscp.repository.aab408eda60c69e6) — the four options this article deferred.
- [File masks](app-doc://article/material-winscp.repository.a3cb68eed237457c) — the `includeFileMask` language.
- [At-rest encryption](app-doc://article/material-winscp.repository.644e9d8291155c00) — what `encryptNewFiles` connects to.
