...
- [Transfer settings](app-doc://article/material-winscp.repository.ede592cd6d4e2d32) — the rest of the options an item carries.
- [The queue](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889) — where a failed item's offset is kept.
- [SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9) and [FTP](app-doc://article/material-winscp.repository.cc7ca4876e7e9ab0) — the two protocols that can actually resume.
- Synchronization — which uses the same overwrite machinery.
