...
2. **A master-password-derived key.** When a
   [master password](app-doc://article/material-winscp.repository.615b74d9401eef58) is set, secrets are encrypted with a key
...
| `security.useMasterPassword` | `false` | See [master password](app-doc://article/material-winscp.repository.615b74d9401eef58). |
...
- [Master password](app-doc://article/material-winscp.repository.615b74d9401eef58) — the second protection route, in detail.
- [Host keys](app-doc://article/material-winscp.repository.0748f1d3b696a738) — verifying the server before a credential is sent.
- [Session logging](app-doc://article/material-winscp.repository.d1ac326b8468819c) — what the logs do and do not contain.
- Version history — how snapshots keep ciphertext as ciphertext.
