...
- [Panels](app-doc://article/material-winscp.repository.318c27a39f1e5801) — layouts, filtering, columns, and file colours.
- Accessibility and languages — keyboard and
  screen-reader rules shared by every surface.
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — the builder
