...
[appearance editor](app-doc://article/material-winscp.repository.caaac4c702e76f8b), which is the test of whether a
...
- [The appearance editor](app-doc://article/material-winscp.repository.caaac4c702e76f8b) — where the picker is used most.
- [Material Design 3](app-doc://article/material-winscp.repository.1474a4afa155711f) — the seed colour and the palette generated from it.
- [Accessibility](app-doc://article/material-winscp.repository.f552e9dcc6996690) — contrast and the not-colour-alone rule.
- [Panels](app-doc://article/material-winscp.repository.318c27a39f1e5801) — file colouring rules, which are data colours and exempt from theming.
