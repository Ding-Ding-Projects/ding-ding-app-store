...
[the site's client application](app-doc://article/material-winscp.repository.2614788641a445aa); this one stays about the builder.
...
- **Trigger:** pushes to `main` that touch the site's inputs, plus
  ...
  four commits into nine releases exactly that way (see [CI](app-doc://article/material-winscp.repository.8db778203c304457)).
...
- [The site's client application](app-doc://article/material-winscp.repository.2614788641a445aa) — what actually runs in the browser.
...
- [Building](app-doc://article/material-winscp.repository.6aad0f73967b3eeb) — building the application rather than the site.
- Search and regex — the builder every search bar on the site has to reach.
