...
- [Language modes](app-doc://article/material-winscp.repository.728997f194376526) — the dictionary these levels index into.
- [The narrator](app-doc://article/material-winscp.repository.71ad1a96a1fee109) — which follows the same levels when speaking.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — where most levelled copy appears.
- [The changelog viewer](app-doc://article/material-winscp.repository.fe6cd7532545ae84) — which is levelled too, including security fixes.
