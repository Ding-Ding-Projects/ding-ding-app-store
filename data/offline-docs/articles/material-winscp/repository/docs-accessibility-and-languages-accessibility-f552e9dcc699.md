...
- Every command is reachable without a pointer, including
  ["Edit appearance…"](app-doc://article/material-winscp.repository.caaac4c702e76f8b), which
...
- The [appearance editor](app-doc://article/material-winscp.repository.caaac4c702e76f8b) and
  the [colour picker](app-doc://article/material-winscp.repository.25d2616d40d87a4c) show a live
...
- **Colour is never the only signal.** Destructive rows in the
  [comparison checklist](app-doc://article/material-winscp.repository.cff66120cc0dd312), error
...
- Nothing auto-plays, auto-scrolls or flashes. The
  [dim sum surprise](app-doc://article/material-winscp.repository.e023cb683da2e265) respects reduced motion like everything else.
...
- The [narrator](app-doc://article/material-winscp.repository.71ad1a96a1fee109) yields to or ducks under an active screen reader.
...
- [Language modes](app-doc://article/material-winscp.repository.728997f194376526) — bilingual mode, the hardest layout case.
- [The narrator](app-doc://article/material-winscp.repository.71ad1a96a1fee109) — coexisting with assistive technology.
- [The appearance editor](app-doc://article/material-winscp.repository.caaac4c702e76f8b) — what customization must never break.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — live regions and focus.
