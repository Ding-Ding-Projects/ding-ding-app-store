...
| `perElement` | `{}` | Per-element overrides — see [the appearance editor](app-doc://article/material-winscp.repository.caaac4c702e76f8b). |
...
- [The appearance editor](app-doc://article/material-winscp.repository.caaac4c702e76f8b) — per-element overrides on top of this.
- [The colour picker](app-doc://article/material-winscp.repository.25d2616d40d87a4c) — how a seed or an override colour is chosen.
- [Accessibility](app-doc://article/material-winscp.repository.f552e9dcc6996690) — the contrast and motion rules.
- [Language modes](app-doc://article/material-winscp.repository.728997f194376526) — why CJK fallback is mandatory.
