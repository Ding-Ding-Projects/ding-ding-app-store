...
[SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9) unless the server genuinely has no SFTP subsystem.
...
- SCP inherits the SSH transport's security wholesale — cipher lists, host key
  verification and agent forwarding behave exactly as in [SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9).
...
- [SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9) — same transport, a real file protocol; prefer it.
- [The adapter contract](app-doc://article/material-winscp.repository.77c1e7f43ee4268a) — why `caps.resume = false` greys out Resume.
- [Custom commands](app-doc://article/material-winscp.repository.0f1843719a666217) — what
  `caps.exec` unlocks, and how arguments are quoted.
- Security and credentials — the SSH trust store shared with SFTP.
