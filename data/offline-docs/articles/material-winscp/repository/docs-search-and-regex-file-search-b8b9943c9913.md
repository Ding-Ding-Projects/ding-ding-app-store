...
| Field | Meaning |
| --- | --- |
| Search for | A [file mask](app-doc://article/material-winscp.repository.a3cb68eed237457c), or a regex when the builder is engaged. |
...
The file-mask field carries the [regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) anchored beside
...
| Clock skew on date criteria | Uses the same time correction as [synchronization](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac). | Yes |
...
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — the builder on this search field.
- [File masks](app-doc://article/material-winscp.repository.a3cb68eed237457c) — the default pattern language here.
- [Panels](app-doc://article/material-winscp.repository.318c27a39f1e5801) — where a result is revealed.
- [Search surfaces](app-doc://article/material-winscp.repository.2488b0d37db25ff3) — the full list of fields with a builder.
