...
- [SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9) — the richest adapter, and the reference implementation.
- [Local filesystem](app-doc://article/material-winscp.repository.7efc8c0b4fe079f1) — the only adapter with Windows path semantics.
- Transfers and the queue — what consumes the streams.
- [Architecture](app-doc://article/material-winscp.repository.140eef3ba41bdcf4) — the wider module contract this sits inside.
