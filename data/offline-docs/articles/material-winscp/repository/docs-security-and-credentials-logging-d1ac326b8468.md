...
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — what redaction is protecting.
- [SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9) and [FTP](app-doc://article/material-winscp.repository.cc7ca4876e7e9ab0) — reading protocol-level logs.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — how a logging failure reports itself.
