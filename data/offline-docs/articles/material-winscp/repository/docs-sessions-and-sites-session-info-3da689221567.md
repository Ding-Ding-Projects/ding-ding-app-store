...
- [Site manager](app-doc://article/material-winscp.repository.3daf06486972e947) — where session data is stored and edited.
- [Adapter contract](app-doc://article/material-winscp.repository.77c1e7f43ee4268a) — the protocol backend
