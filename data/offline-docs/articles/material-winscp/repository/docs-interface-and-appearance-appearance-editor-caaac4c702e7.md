...
[regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2), searching property names,
...
- [The colour picker](app-doc://article/material-winscp.repository.25d2616d40d87a4c) — the control behind every colour field here.
- [Material Design 3](app-doc://article/material-winscp.repository.1474a4afa155711f) — the tokens an override sits on top of.
- [Tabs and navigation](app-doc://article/material-winscp.repository.b0a933757c6fef67) — tabs and groups as appearance targets.
- [Accessibility](app-doc://article/material-winscp.repository.f552e9dcc6996690) — the guarantees an override must not break.
