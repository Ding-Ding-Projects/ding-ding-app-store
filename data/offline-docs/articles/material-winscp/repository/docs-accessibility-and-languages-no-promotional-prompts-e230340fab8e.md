...
- [Language modes](app-doc://article/material-winscp.repository.728997f194376526) — the policy applies in every language.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — the
