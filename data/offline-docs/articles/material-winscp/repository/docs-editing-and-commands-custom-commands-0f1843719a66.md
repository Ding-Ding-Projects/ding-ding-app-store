...
| Mask | A [file mask](app-doc://article/material-winscp.repository.a3cb68eed237457c) restricting which files it appears for. |
...
| Command waits for input | Detected by a timeout; the command is terminated and reported as needing input. Interactive commands belong in the [console](app-doc://article/material-winscp.repository.2036717365155926). | Yes |
...
| Local command with the file not yet downloaded | Downloaded to a temporary first, and uploaded back afterwards if it changed — the same cycle as [editors](app-doc://article/material-winscp.repository.29bfa1ddbd07f338). | Yes |
...
- [The console](app-doc://article/material-winscp.repository.2036717365155926) — for commands that need interaction.
- [File masks](app-doc://article/material-winscp.repository.a3cb68eed237457c) — restricting where a command appears.
- [Editors](app-doc://article/material-winscp.repository.29bfa1ddbd07f338) — the same download-edit-upload cycle for local commands.
- [SCP](app-doc://article/material-winscp.repository.5dc0057fa313f047) — the protocol that makes remote commands possible.
