...
- **The builder is exercised from every search surface** listed in
  [search surfaces](app-doc://article/material-winscp.repository.2488b0d37db25ff3), not only from one.
...
- [Search surfaces](app-doc://article/material-winscp.repository.2488b0d37db25ff3) — every field this is attached to.
- [File masks](app-doc://article/material-winscp.repository.a3cb68eed237457c) — the simpler language, and its conversion to regex.
- [File search](app-doc://article/material-winscp.repository.b8b9943c99132621) — the largest consumer of built patterns.
- [Tab search](app-doc://article/material-winscp.repository.fddab57862530c8d) — four independent builders on one surface.
