...
- [The site manager](app-doc://article/material-winscp.repository.3daf06486972e947) — where these options are stored and exported.
- [Reconnection](app-doc://article/material-winscp.repository.d12c73c616be13c5) — how a two-hop connection is re-established.
- [SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9) — the transport a tunnel is built from.
- [Host key verification](app-doc://article/material-winscp.repository.0748f1d3b696a738) — pinning the jump host.
