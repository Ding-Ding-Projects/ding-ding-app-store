...
- **Tone follows the [funny level](app-doc://article/material-winscp.repository.8dd415c0d17db8b3)** for the language being
...
- [Funny levels](app-doc://article/material-winscp.repository.8dd415c0d17db8b3) — the tone the narrator follows.
- [Language modes](app-doc://article/material-winscp.repository.728997f194376526) — the dictionary it speaks from.
- [Accessibility](app-doc://article/material-winscp.repository.f552e9dcc6996690) — coexisting with assistive technology.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — the visual half, which narration never replaces.
