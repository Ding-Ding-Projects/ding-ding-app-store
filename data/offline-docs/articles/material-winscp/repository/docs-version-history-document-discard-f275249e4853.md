...
- [History snapshots](app-doc://article/material-winscp.repository.9b849c9c664a138d) — append-only state and restore semantics.
- [Internal and external editors](app-doc://article/material-winscp.repository.29bfa1ddbd07f338) — the
