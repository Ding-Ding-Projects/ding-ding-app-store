...
- [The interface and appearance index](app-doc://article/material-winscp.repository.9ff63e1764b09912)
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — user-facing startup failures remain visible UI events, not hidden telemetry.
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — secrets use the separate protected store and never enter this document.
