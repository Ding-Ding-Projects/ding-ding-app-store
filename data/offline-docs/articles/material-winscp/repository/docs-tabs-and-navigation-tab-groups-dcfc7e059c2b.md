...
| Colour and icon | Chosen with the [infinite colour picker](app-doc://article/material-winscp.repository.25d2616d40d87a4c); the icon may be an emoji. |
...
- **Within a group** — each group has its own tab search field, scoped to its
  members, with its own anchored [regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2).
...
[tab search](app-doc://article/material-winscp.repository.fddab57862530c8d).
...
- [The tab strip](app-doc://article/material-winscp.repository.7e9769a41f9d5333) — the surface groups live in.
- [Tab search](app-doc://article/material-winscp.repository.fddab57862530c8d) — all four searches, and why they are separate.
- [Tab appearance](app-doc://article/material-winscp.repository.b0a933757c6fef67) — the per-element editor for headers and tabs.
- [Workspaces](app-doc://article/material-winscp.repository.c764da55f312b773) — restoring a whole group structure.
