...
Node is pinned to 22 (see [building](app-doc://article/material-winscp.repository.6aad0f73967b3eeb) for why).
...
a bot — see [releases](app-doc://article/material-winscp.repository.ec20b3572803cd00).

The Pages workflow deploys through
...
- `npm run make` produces the installer described in [building](app-doc://article/material-winscp.repository.6aad0f73967b3eeb).
...
No claim is made here that CI is green. See `HANDOFF.md`.

## Suggested articles

- [Releases](app-doc://article/material-winscp.repository.ec20b3572803cd00) — what a successful run publishes.
- [Building](app-doc://article/material-winscp.repository.6aad0f73967b3eeb) — the same build, locally.
- [The installer](app-doc://article/material-winscp.repository.717d02e12a4672e9) — the artefact CI ships.
- [The dim sum surprise](app-doc://article/material-winscp.repository.e023cb683da2e265) — the catalog CI reads.
