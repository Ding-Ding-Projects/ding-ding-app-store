...
place in the tab structure — order, pinned state,
...
- [The site manager](app-doc://article/material-winscp.repository.3daf06486972e947) — where workspaces live alongside sites.
- Tabs and navigation — the structure a workspace preserves.
- [Reconnection](app-doc://article/material-winscp.repository.d12c73c616be13c5) — what happens after a restored session drops.
- Version history — undoing a deleted workspace.
