...
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — what is sent *after* verification succeeds.
- [Reconnection](app-doc://article/material-winscp.repository.d12c73c616be13c5) — why a key change stops a retry loop.
- [Tunnels and proxies](app-doc://article/material-winscp.repository.abd9b694c21333cb) — pinning a jump host.
- [SFTP](app-doc://article/material-winscp.repository.07a5111c637447e9) and [FTP](app-doc://article/material-winscp.repository.cc7ca4876e7e9ab0) — the algorithm and TLS options.
