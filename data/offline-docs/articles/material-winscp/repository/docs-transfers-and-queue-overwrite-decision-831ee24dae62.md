...
truncated file that looks complete. See [resume.md](app-doc://article/material-winscp.repository.aab408eda60c69e6).
...
- [resume.md](app-doc://article/material-winscp.repository.aab408eda60c69e6) — `.filepart` files, the resume threshold, and what
  each protocol can actually do.
- [transfer-settings.md](app-doc://article/material-winscp.repository.ede592cd6d4e2d32) — where *Confirm overwriting*,
  *Confirm resume* and *only newer* are set.
- [queue.md](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889) — how a queued item reaches this decision, and what
  parallel transfers change about it.
- [../protocol-gaps.md](app-doc://article/material-winscp.repository.84fd40b3f8f07b83) — the capability differences that
