...
- A **search bar** wired to the [regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2).
- A **date filter** using the same advanced calendar as the
  [changelog viewer](app-doc://article/material-winscp.repository.fe6cd7532545ae84) — month and year
...
["Edit appearance…"](app-doc://article/material-winscp.repository.caaac4c702e76f8b).
...
- [The appearance editor](app-doc://article/material-winscp.repository.caaac4c702e76f8b) — restyling notifications.
- [Accessibility](app-doc://article/material-winscp.repository.f552e9dcc6996690) — live regions and focus rules.
- [The queue](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889) — the largest producer of notifications.
- [The changelog viewer](app-doc://article/material-winscp.repository.fe6cd7532545ae84) — the shared date-filter control.
