...
- A Latin-only font falls back through a CJK-safe chain — see
  [Material Design 3](app-doc://article/material-winscp.repository.1474a4afa155711f).
...
| `funnyLevel.en`, `funnyLevel.yue` | `3`, `3` | See [funny levels](app-doc://article/material-winscp.repository.8dd415c0d17db8b3). |
...
- [Funny levels](app-doc://article/material-winscp.repository.8dd415c0d17db8b3) — the sliders that pick a variant.
- [Accessibility](app-doc://article/material-winscp.repository.f552e9dcc6996690) — naming, focus and announcement rules.
- [The narrator](app-doc://article/material-winscp.repository.71ad1a96a1fee109) — the spoken counterpart.
- [Material Design 3](app-doc://article/material-winscp.repository.1474a4afa155711f) — CJK-safe fonts.
