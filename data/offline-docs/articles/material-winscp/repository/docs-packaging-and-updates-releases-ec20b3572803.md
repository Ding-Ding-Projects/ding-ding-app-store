...
Every successful [CI](app-doc://article/material-winscp.repository.8db778203c304457) run publishes exactly one **non-draft** GitHub
Release carrying:
...
(that would retrigger itself — see [CI](app-doc://article/material-winscp.repository.8db778203c304457)).
...
- The release notes.
- The [changelog viewer](app-doc://article/material-winscp.repository.fe6cd7532545ae84) entry.
...
[funny level](app-doc://article/material-winscp.repository.8dd415c0d17db8b3) and in every
...
- [CI](app-doc://article/material-winscp.repository.8db778203c304457) — what publishes a release.
- [Building](app-doc://article/material-winscp.repository.6aad0f73967b3eeb) — the artefacts a release carries.
- [The changelog viewer](app-doc://article/material-winscp.repository.fe6cd7532545ae84) — where code names appear in-app.
- [The dim sum surprise](app-doc://article/material-winscp.repository.e023cb683da2e265) — the same catalog, the other feature.
