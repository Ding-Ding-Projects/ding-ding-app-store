...
| --- | --- | --- |
| `userName` | `''` | |
| `password` | `''` | Stored encrypted or not at all — see [credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4). |
...
| Open a folder | Opens every site below the selected folder, including sites nested in child folders, in tree order. A failed connection is reported and does not prevent later sites from being attempted. |
...
The site list has a search bar with the [regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2)
...
- [Workspaces](app-doc://article/material-winscp.repository.c764da55f312b773) — restoring several of these at once.
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — where a saved password actually goes.
- Version history — the undo behind every edit here.
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — the builder on the site search bar.
