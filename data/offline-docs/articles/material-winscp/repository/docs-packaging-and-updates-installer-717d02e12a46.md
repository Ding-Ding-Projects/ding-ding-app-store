...
The installer was **built and inspected** — see [building](app-doc://article/material-winscp.repository.6aad0f73967b3eeb) for the
...
`HANDOFF.md` records that gap explicitly.

## Suggested articles

- [Building](app-doc://article/material-winscp.repository.6aad0f73967b3eeb) — producing the installer.
- [Updates](app-doc://article/material-winscp.repository.4dab9d9d6933f6db) — the in-app half of the update flow.
- [CI](app-doc://article/material-winscp.repository.8db778203c304457) — where release installers are built.
- [Releases](app-doc://article/material-winscp.repository.ec20b3572803cd00) — where they are published.
