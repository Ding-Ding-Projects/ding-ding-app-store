...
`Duplicate` button or Ctrl+D (Cmd+D on macOS). The copy
...
- [The site manager](app-doc://article/material-winscp.repository.3daf06486972e947) — saved connection identity and folders.
- [Session information](app-doc://article/material-winscp.repository.3da6892215673979) — the secret-free live session snapshot.
- [Workspaces](app-doc://article/material-winscp.repository.c764da55f312b773) — restoring several sessions and their paths.
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — searching a site or bookmark list safely.
