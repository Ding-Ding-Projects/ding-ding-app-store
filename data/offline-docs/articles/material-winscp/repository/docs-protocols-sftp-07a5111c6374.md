...
[SCP](app-doc://article/material-winscp.repository.5dc0057fa313f047).
...
- [The adapter contract](app-doc://article/material-winscp.repository.77c1e7f43ee4268a) — where `caps` comes from.
- [SCP](app-doc://article/material-winscp.repository.5dc0057fa313f047) — the same SSH transport, a very different file layer.
- [Host key verification](app-doc://article/material-winscp.repository.0748f1d3b696a738) — the trust store behind the modal.
- Transfers and the queue — resume, parallelism and speed limits.
