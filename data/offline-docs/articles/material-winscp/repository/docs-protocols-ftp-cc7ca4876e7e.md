...
- [The adapter contract](app-doc://article/material-winscp.repository.77c1e7f43ee4268a) — how post-connect capability resolution reaches the UI.
- [WebDAV](app-doc://article/material-winscp.repository.84ede37559ada49f) — the other TLS-over-HTTP client, with a similar trust store.
- [Certificates and trust](app-doc://article/material-winscp.repository.0748f1d3b696a738) — where accepted fingerprints live.
- [Transfers and the queue](app-doc://article/material-winscp.repository.aab408eda60c69e6) — what `REST` support does and does not buy.
