...
anchored [regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) and applies its
...
- [Tab search](app-doc://article/material-winscp.repository.fddab57862530c8d) — the same predicate, without the destruction.
- [The tab strip](app-doc://article/material-winscp.repository.7e9769a41f9d5333) — pinning, and why it protects.
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — the builder both actions must offer.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — how the honest result is reported.
