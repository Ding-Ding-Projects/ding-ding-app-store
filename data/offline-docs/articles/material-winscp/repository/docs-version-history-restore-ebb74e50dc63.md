...
- [Snapshots](app-doc://article/material-winscp.repository.9b849c9c664a138d) — what is captured, and when.
- [The history panel](app-doc://article/material-winscp.repository.20297aa033513700) — where a restore is initiated.
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — the AAD binding, from the other side.
- [Host keys](app-doc://article/material-winscp.repository.0748f1d3b696a738) — why restoring a trust decision is highlighted.
