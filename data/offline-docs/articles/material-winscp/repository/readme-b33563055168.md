...
[*Image omitted from the offline bundle: Node.*](app-doc://article/material-winscp.repository.6aad0f73967b3eeb)
[*Image omitted from the offline bundle: Installer.*](app-doc://article/material-winscp.repository.717d02e12a4672e9)
[*Image omitted from the offline bundle: Design.*](app-doc://article/material-winscp.repository.1474a4afa155711f)
...
Requires **Node 22 LTS** on Windows — [here is why the version matters](app-doc://article/material-winscp.repository.6aad0f73967b3eeb).

## Documentation

📖 **[`docs/`](app-doc://article/material-winscp.repository.0b5ca119d2be595a)** — one article per feature, in twelve categories.
...
running the site. There is no `site/index.html` to open
directly: the sources live in `site/src/` and the site is emitted into
`site/_site/`.

🏗 **[`docs/architecture.md`](app-doc://article/material-winscp.repository.140eef3ba41bdcf4)** — read this before writing
any code here.
...
🔌 Protocols — SFTP, SCP, FTP/FTPS, WebDAV, S3 and the local filesystem
...
→ [`docs/protocols/`](app-doc://article/material-winscp.repository.dcce46153082ff4e)




📦 Transfers and the queue — parallelism, resume, throttling, presets
...
→ [`docs/transfers-and-queue/`](app-doc://article/material-winscp.repository.ab96690ba76ca310)




🔄 Synchronization — comparison checklist, mirroring, keep-up-to-date
...
→ [`docs/synchronization/`](app-doc://article/material-winscp.repository.ae15855c99683c53)




🗂 Sessions and sites — site manager, workspaces, tunnels, proxies, reconnection
...
→ [`docs/sessions-and-sites/`](app-doc://article/material-winscp.repository.b9408ef2b68e0f3e)




🔐 Security and credentials — host keys, credential storage, master password, encryption
...
→ [`docs/security-and-credentials/`](app-doc://article/material-winscp.repository.35e39ee6f589ef48)




✏️ Editing and commands — editors, custom commands, file masks, the console
...
→ [`docs/editing-and-commands/`](app-doc://article/material-winscp.repository.20e347416ce77e44)




🎨 Interface and appearance — M3 tokens, per-element editing, the infinite colour picker
...
→ [`docs/interface-and-appearance/`](app-doc://article/material-winscp.repository.9ff63e1764b09912)




🗃 Tabs and navigation — overflow, pinning, grouping, four searches, bulk close
...
→ [`docs/tabs-and-navigation/`](app-doc://article/material-winscp.repository.6394a8281dab7171)




🔍 Search and regex — the builder, every surface it is on, file search
...
→ [`docs/search-and-regex/`](app-doc://article/material-winscp.repository.e12dca99f621be3f)




🕰 Version history — everything you own, undoable, append-only
...
→ [`docs/version-history/`](app-doc://article/material-winscp.repository.7ea2a50b692f2714)




🗣 Accessibility and languages — three modes, two funny sliders, the narrator, dim sum
...
→ [`docs/accessibility-and-languages/`](app-doc://article/material-winscp.repository.c72ae6e22ebfe928)




📦 Packaging and updates — the installer, CI, releases, the changelog viewer
...
→ [`docs/packaging-and-updates/`](app-doc://article/material-winscp.repository.0ec8b898e84ac884)
...
Which rule decided each commit, and how to check it
...
[`docs/editing-and-commands/cli.md`](app-doc://article/material-winscp.repository.91a2af36decd0a9e).
...
- **Read [`docs/architecture.md`](app-doc://article/material-winscp.repository.140eef3ba41bdcf4) first.** It is the
...
More in `CONTRIBUTING.md` and `AGENTS.md`.
...
What is real, what is verified, and what is not
...
`ROADMAP.md` and `HANDOFF.md` carry the full picture.
...
Sanitized mirror of the shared agent instructions — the rules any agent working in this repository follows
...
> than dropped.
>
> **`AGENTS.md` carries the full mirror.** What follows is the
...
**[Documentation](app-doc://article/material-winscp.repository.0b5ca119d2be595a)** · **[Architecture](app-doc://article/material-winscp.repository.140eef3ba41bdcf4)** · **Roadmap** · **Handoff** · **Contributing** · **Security**

Licensed under GPL-3.0-or-later, as a port of
