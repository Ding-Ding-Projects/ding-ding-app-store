...
[regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) when a user needs more
...
- **Masks are a safety mechanism, not just a filter.** In a
  [synchronize with delete](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac), an excluded file
...
- **Excluding secrets is a documented use** — `.env`, `*.pem`, `id_*`, `.git/` —
  and the [keep-up-to-date](app-doc://article/material-winscp.repository.04b191ece9141ae0) start dialog
  suggests them.
...
- [Transfer settings](app-doc://article/material-winscp.repository.ede592cd6d4e2d32) — `includeFileMask` and `asciiFileMask`.
- [Synchronize](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac) — where exclusion becomes a safety property.
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — where a mask hands over.
- [Custom commands](app-doc://article/material-winscp.repository.0f1843719a666217) — masks decide which commands apply to a file.
