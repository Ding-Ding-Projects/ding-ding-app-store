...
> for it — see the [category index](app-doc://article/material-winscp.repository.dcce46153082ff4e).
...
- [S3](app-doc://article/material-winscp.repository.968e9ab43a8535ed) — the other HTTP-based backend, with a different security model entirely.
- [FTP and FTPS](app-doc://article/material-winscp.repository.cc7ca4876e7e9ab0) — shares the certificate trust store and TLS options.
- [Editors](app-doc://article/material-winscp.repository.29bfa1ddbd07f338) — why ETags matter when editing remote files.
- [The adapter contract](app-doc://article/material-winscp.repository.77c1e7f43ee4268a) — why `chmod` is greyed out rather than failing.
