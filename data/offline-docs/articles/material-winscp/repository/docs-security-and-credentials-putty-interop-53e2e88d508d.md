...
[PuTTY private-key preflight](app-doc://article/material-winscp.repository.93667f41c74367bd) for that production seam.
...
Focused coverage lives in `test/putty.test.js`:
...
- [Host keys](app-doc://article/material-winscp.repository.0748f1d3b696a738) — verify the server separately from key-file metadata.
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — how secrets are protected at rest.
- [Master password](app-doc://article/material-winscp.repository.615b74d9401eef58) — the fallback protection boundary.
