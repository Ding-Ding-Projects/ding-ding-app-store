...
[named preset](app-doc://article/material-winscp.repository.ede592cd6d4e2d32#presets) — "Overnight bulk upload" at
...
- [The queue](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889) — concurrency, and why limits multiply across items.
- [Transfer settings](app-doc://article/material-winscp.repository.ede592cd6d4e2d32) — where `cpsLimit` lives and how presets carry it.
- [Resume](app-doc://article/material-winscp.repository.aab408eda60c69e6) — interacts with throttling on long transfers.
