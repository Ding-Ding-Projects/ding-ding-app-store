...
- [Synchronize](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac) — directions, modes and comparison criteria.
- [Comparison checklist](app-doc://article/material-winscp.repository.cff66120cc0dd312) — review and apply policy.
- Transfers and the queue — where accepted rows go.
