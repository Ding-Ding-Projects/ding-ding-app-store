...
restored with the [workspace](app-doc://article/material-winscp.repository.c764da55f312b773). Columns a
...
[mask](app-doc://article/material-winscp.repository.a3cb68eed237457c) colours the row — build output in
...
[colour picker](app-doc://article/material-winscp.repository.25d2616d40d87a4c), and each rule carries a separate colour for
light and dark so a rule stays legible in both.

### Filter and search

Each panel has a filter field with the
[regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) anchored beside it. An
...
as a no-op. See [Drag and drop](app-doc://article/material-winscp.repository.ab81621741087a42) for the
...
| Panel comparison with clock skew | Uses the same time correction as [synchronization](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac). | Yes |
...
- [File masks](app-doc://article/material-winscp.repository.a3cb68eed237457c) — the language behind filters and colour rules.
- [Material Design 3](app-doc://article/material-winscp.repository.1474a4afa155711f) — and why data colours are exempt from it.
- [Workspaces](app-doc://article/material-winscp.repository.c764da55f312b773) — what persists a panel layout.
- [The regex builder](app-doc://article/material-winscp.repository.e00a792e9bc916e2) — the builder on each panel filter.
