...
- [Synchronize](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac) — the one-shot operation, and the comparison that starts a watch.
- [The comparison checklist](app-doc://article/material-winscp.repository.cff66120cc0dd312) — what the initial comparison produces.
- [File masks](app-doc://article/material-winscp.repository.a3cb68eed237457c) — the exclusion language that keeps secrets out of a watch.
- [The queue](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889) — where watched changes are executed.
