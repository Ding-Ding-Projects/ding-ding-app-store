...
| `encryptKey` | `''` | The key. Stored like any other secret — see [credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4). |
...
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — where `encryptKey` lives.
- [S3](app-doc://article/material-winscp.repository.968e9ab43a8535ed) — the storage this matters most for.
- [Synchronize](app-doc://article/material-winscp.repository.0a1ea65f73dd97ac) — why size comparison misleads here.
- [Resume](app-doc://article/material-winscp.repository.aab408eda60c69e6) — the key check before an encrypted resume.
