...
Focused coverage is in `test/sitedata.test.js`:
...
- [Site manager](app-doc://article/material-winscp.repository.3daf06486972e947) — review and organize imported sites.
- [PuTTY interoperability](app-doc://article/material-winscp.repository.53e2e88d508d9464) —
  safe key and setting metadata boundaries.
- [Host keys](app-doc://article/material-winscp.repository.0748f1d3b696a738) — verify the endpoint
