...
| `makers[0]` | `@electron-forge/maker-squirrel` — see [installer](app-doc://article/material-winscp.repository.717d02e12a4672e9) |
| `makers[1]` | `@electron-forge/maker-zip` |
| `publishers` | **Empty, deliberately.** [CI](app-doc://article/material-winscp.repository.8db778203c304457) publishes with the `gh` CLI so the notes can carry the dim sum code name and photo. |
...
`HANDOFF.md` for exactly what was and was not verified.

## Suggested articles

- [The installer](app-doc://article/material-winscp.repository.717d02e12a4672e9) — what the Setup.exe does when run.
- [CI](app-doc://article/material-winscp.repository.8db778203c304457) — the same build on a hosted runner.
- [Releases](app-doc://article/material-winscp.repository.ec20b3572803cd00) — where the artefacts go.
- [The dim sum surprise](app-doc://article/material-winscp.repository.e023cb683da2e265) — the catalog the icon came from.
