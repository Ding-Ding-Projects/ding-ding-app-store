...
- [Credential storage](app-doc://article/material-winscp.repository.9d2325dcc3bf8dd4) — the layer this plugs into.
- [The site manager](app-doc://article/material-winscp.repository.3daf06486972e947) — where secrets are entered and exported.
- Version history — snapshots hold ciphertext, so history is never more sensitive than the store.
