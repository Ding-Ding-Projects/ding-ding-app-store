...
user-initiated apply; see [the installer](app-doc://article/material-winscp.repository.717d02e12a4672e9) for the on-disk
mechanics.
...
- **Checks are never blocking.** They run in the background; a result arrives as
  a [corner notification](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) with a
...
- **The offer includes the version, the release date and the dim sum code name**,
  ...
  [changelog](app-doc://article/material-winscp.repository.fe6cd7532545ae84).
...
- **A restart to apply an update can lose queued transfers**, since the queue is
  deliberately not persisted (see [the queue](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889)).
...
- [The installer](app-doc://article/material-winscp.repository.717d02e12a4672e9) — the Squirrel mechanics behind an update.
- [Releases](app-doc://article/material-winscp.repository.ec20b3572803cd00) — what an update points at.
- [The changelog viewer](app-doc://article/material-winscp.repository.fe6cd7532545ae84) — what the offer links to.
- [The queue](app-doc://article/material-winscp.repository.a97eb2e4ae1a0889) — why a restart prompt mentions it.
