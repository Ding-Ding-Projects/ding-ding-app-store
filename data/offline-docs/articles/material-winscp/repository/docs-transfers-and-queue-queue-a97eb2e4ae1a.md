...
- **An item's settings are a snapshot.** See the note in the
  [category index](app-doc://article/material-winscp.repository.ab96690ba76ca310) — this is intentional.
...
- **A dropped connection is bounded by `security.sessionReopenTimeout`, not by a
  ...
  - Only FTP and FTPS have a budget at all; every other protocol reconnects
    ...
    [Reconnection](app-doc://article/material-winscp.repository.d12c73c616be13c5).
...
- [Transfer settings](app-doc://article/material-winscp.repository.ede592cd6d4e2d32) — what an item's snapshot actually contains.
- [Resume](app-doc://article/material-winscp.repository.aab408eda60c69e6) — what happens to a failed item's byte offset.
- [Speed limits](app-doc://article/material-winscp.repository.22b4cd406df4a5ee) — throttling without pausing.
- [Notifications](app-doc://article/material-winscp.repository.e5539f064fd1d9fe) — why queue results are toasts, not dialogs.
