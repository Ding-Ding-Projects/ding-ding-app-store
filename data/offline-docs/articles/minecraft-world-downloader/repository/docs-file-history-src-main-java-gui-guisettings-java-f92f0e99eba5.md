# `src/main/java/gui/GuiSettings.java`

**Java** · 386 lines · 13,168 bytes · 34 commit(s) · first 2021-02-13 · last 2024-05-25
...
| 2021-03-18 | `cc77daf` | Mirco Kroon | Hide realms tab when started, improved address handling |
| 2021-03-17 | `cb15ac4` | Mirco Kroon | Improved error handling for realms |
...
| 2021-02-21 | `97c8558` | Mirco Kroon | Allow negative values in number fields |
...
| 2021-02-16 | `49f7930` | Mirco Kroon | Improve checkbox styling |
