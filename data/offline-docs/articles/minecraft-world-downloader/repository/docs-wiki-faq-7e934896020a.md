...
You must sign in to your Minecraft account — see Authentication. With the jar, use the
...
latest build. See Supported Versions.
...
(e.g. `"25566:25565"`) and connect Minecraft to that port. See Docker & Web Console.
...
1.8 through 26.1 — see Supported Versions. In-between versions map to the nearest
supported protocol.
