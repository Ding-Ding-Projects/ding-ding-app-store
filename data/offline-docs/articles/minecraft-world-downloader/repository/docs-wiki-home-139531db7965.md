...
## Contents
- **Installation** — download the jar or run it with Docker
- **Docker & Web Console** — run headless with a browser UI
- **Authentication** — sign in to your Minecraft account
- **Supported Versions** — every version from 1.8 to 26.1
...
- **Supports Minecraft 1.8 → 26.1** (see Supported Versions).
- Optional **Docker web console** to run and manage it from a browser.
...
> For problems, see the FAQ or open an issue on GitHub.
