...
- **Live map in the web console** — the overview map now renders **headless** (no GUI) into PNG region
  ...
  surface/caves toggle. On by default in `--no-gui` mode; see `bluemap/` for the 3D map.
- **BlueMap 3D map pipeline** (`bluemap/pipeline.py`) — upgrade a downloaded
...
- **Mineflayer auto-scraper** (`scraper/`) — bots that walk/fly a grid through the proxy to
...
### 📖 Documentation
Full guides are in **`docs/wiki/`** (also published to the project
[wiki](https://github.com/cafepromenade/minecraft-world-downloader/wiki)):
[Installation](app-doc://article/minecraft-world-downloader.repository.1924d8c509ad7c15) ·
[Docker & web console](app-doc://article/minecraft-world-downloader.repository.4cfa1e60b5b7d7d3) ·
[Authentication](app-doc://article/minecraft-world-downloader.repository.f1a1f319f1a1bd17) ·
[Supported versions](app-doc://article/minecraft-world-downloader.repository.a1c4d109d088252f) ·
[Command-line options](app-doc://article/minecraft-world-downloader.repository.79cda5c305231076) ·
[Building from source](app-doc://article/minecraft-world-downloader.repository.0bf26af4eea6777d) ·
[FAQ](app-doc://article/minecraft-world-downloader.repository.7e934896020afd25)

**Contributors / maintainers / agents:** see **`handoff.md`** (project state, architecture,
open items), **`AGENTS.md`** (build/test/run + conventions), and
[**`docs/features/`**](app-doc://article/minecraft-world-downloader.repository.e7e392e08738485b) — a per-feature handoff index with one detailed document
per feature. Third-party credits and dependency links are in **`CREDITS.md`**.

### Downloads  *Image or external asset omitted from the offline bundle.*
...
[`docs/testing/goal-3pass-report.md`](app-doc://article/minecraft-world-downloader.repository.322a6f878667db1c) for the full 3-pass Docker
...
**CREDITS.md** for the full list of contributors, forks, and every third-party
