...
- A supported Minecraft version — see Supported Versions (1.8 → 26.1).
...
See Command-Line Options for every flag.
...
For online-mode servers you must sign in to your Minecraft account — see Authentication.
