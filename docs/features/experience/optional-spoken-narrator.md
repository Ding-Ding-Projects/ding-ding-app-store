---
id: optional-spoken-narrator
title: Optional spoken narrator
titleYue: 可選語音旁白
category: experience
status: shipped
summary: Optional renderer-only notification speech with serialized English and Hong Kong Cantonese delivery.
---
