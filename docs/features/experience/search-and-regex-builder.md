...
titleYue: 搜尋同 Regex 建造器
category: experience
status: shipped
summary: Gives every current collection/settings surface independent plain-text-first search and the same adjacent guided JavaScript regex builder.
---
