...
- [Tab and group UX locks with local Support Tickets](./tab-and-group-locks-and-support-tickets.md) — Password- or TOTP-backed local UX locks for tabs, groups, and individual appearance properties, with an honest operating-system vault boundary and an on-device recovery desk.
