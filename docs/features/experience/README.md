...
- [Tab workspace](./tab-navigation.md) — Keeps six fixed pages in a persistent searchable rail with pinning, groups, reordering, overflow, keyboard control, and JSON import/export.
