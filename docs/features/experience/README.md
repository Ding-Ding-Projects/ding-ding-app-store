...
- [Settings, language, and display name](./settings-language-and-display-name.md) — Persists language, two independent funny levels, optional narrator preferences, theme, density, accent, and a display-only app name through tabbed searchable settings.
