...
category: experience
status: shipped
summary: Persists language, two independent funny levels, optional narrator preferences, theme, density, accent, and a display-only app name through tabbed searchable settings.
---
