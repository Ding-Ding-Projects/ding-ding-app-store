...
- [Local authenticator preview](./memory-sync/authenticator.md) — **limited** — Calculates one RFC 6238 code in memory while the operating-system vault and full authenticator remain unavailable.
