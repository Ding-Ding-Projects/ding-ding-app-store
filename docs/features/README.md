...
- [Appearance editor](./experience/appearance-editor.md) — **limited** — Registers shell elements for validated live CSS-variable overrides with continuous HEX/RGB/HSL colour controls, typography controls, reset, import, and export.
