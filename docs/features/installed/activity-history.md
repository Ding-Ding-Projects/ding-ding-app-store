...
category: installed
status: shipped
summary: Appends every install, build, and uninstall result, offers composed filters, and exports the selected or filtered log through a truthful 17-format registry.
---
