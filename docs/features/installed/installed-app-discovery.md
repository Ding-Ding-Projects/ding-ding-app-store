...
category: installed
status: shipped
summary: Detects reviewed registry installs while keeping external discovery separate from exact App Store ownership and removal authority.
---
...
- [Launch installed applications](launch-installed-applications.md)
