...
- **Memory synchronization:** Shared Status Hub (limited), Shared convenience skills (limited), Local authenticator preview (limited), Secret and display-name mutation history (limited)
