...
- NotificationCenter offers selected-record Recovery details: it summarizes typed recovery kinds without inventing a retry because persisted history intentionally contains no callback or operation ID.
