...
- A closed 49-ID install-adapter map: 44 reviewed Squirrel/MSI/NSIS/Mozilla-NSIS/jpackage/portable routes and five explicit public-state blockers. The latest public setup executables for the nine newly reviewed Squirrel routes were verified Authenticode NotSigned on 2026-08-22; clean-Windows installation, launch, and packaged-UI proof remain pending verification lanes, and no row is promoted to verified by release evidence alone.
...
- Offline documentation articles with an in-app browser and full local search/regex builder, including 49 generated catalog metadata records with public source links and truthful adapter/blocker boundaries.
