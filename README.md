...
- A top-level Authenticator tab provides a bounded one-shot RFC 6238 preview for SHA-1/SHA-256/SHA-512 with 6–8 digits and no persistence; the OS credential vault, QR/`otpauth://` registration, and full entry management remain explicitly unavailable.
