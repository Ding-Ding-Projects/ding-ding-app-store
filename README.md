...
**Current state:** active development; the latest verified unsigned Windows release is [`v0.1.0-282-1`](https://github.com/Ding-Ding-Projects/ding-ding-app-store/releases/tag/v0.1.0-282-1), code-named **Steamed Eggplant Stuffed with Shrimp · 百花釀茄子**.
