...
const ELEMENT_LIST = [
  ...
  { key: 'app-avatar', en: 'Application mark', yue: '應用標誌', group: 'content', tokens: BOX_RAISED },
  ...
  { key: 'catalog-state', en: 'Catalog state notice', yue: '目錄狀態通知', group: 'feedback', tokens: BOX_RAISED },
