...
export const INSTALL_ADAPTERS: Readonly<Record<CatalogAppId, InstallAdapter>> = {
  ...
  'material-cookie-clicker': squirrel('material-cookie-clicker-squirrel', 'material-cookie-clicker', /^MaterialCookieClicker-Setup\.exe$/, ['Material Cookie Clicker'], ['package.json: electron-builder Squirrel target and MaterialCookieClicker identity'], undefined, ['Material Cookie Clicker.exe']),
  'material-encryption': squirrel('material-encryption-squirrel', 'material-encryption', /^MaterialEncryption-Setup-[0-9A-Za-z.+-]+\.exe$/, ['Material Encryption'], ['package.json: Squirrel.Windows release target', 'build/material-encryption.ico: first-party icon and package identity'], undefined, ['Material Encryption.exe']),
