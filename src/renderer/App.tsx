  ...
  return (
    <SearchContext.Provider value={search}>
      ...
      <TabRail
        ...
        {panelOpen && appearance.editMode && <AppearancePanel appearance={appearance} settings={settings} notify={notify} locks={locks} schoolModeEnabled={schoolMode.restricted} onManageLock={(target, returnFocus) => { appearanceReturnFocusRef.current = returnFocus; setPanelOpen(false); openLockSupport(target); }} onClose={closeAppearancePanel} />}
