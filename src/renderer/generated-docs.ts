// Generated by scripts/docs-generate.mjs. Edit docs/features instead.
...
export const GENERATED_DOCS: readonly GeneratedDocArticle[] = [
  {
    "id": "catalog-discovery",
    "title": "Catalog discovery",
    "titleYue": "目錄探索",
    "category": "discovery",
    "wiki": "Catalog-Discovery",
    "status": "shipped",
    "related": [
  ...
  },
  {
    ...
    "wiki": "Verified-Installer-Operations",
    "status": "limited",
    "related": [
      "catalog-discovery",
  ...
  },
  {
    ...
    "category": "installation",
    "wiki": "Automatic-Repair-and-Universal-Adapters",
    "status": "pending",
    "related": [
      "verified-installer-operations",
      "source-build-security",
  ...
  },
  {
    ...
    "titleYue": "設定、語言同顯示名稱",
    "category": "experience",
    "wiki": "Settings-Language-and-Display-Name",
    "status": "shipped",
    "related": [
      "command-palette",
      "appearance-editor",
  ...
  },
  {
    ...
    "wiki": "Offline-Documentation-Browser",
    "status": "shipped",
    "related": [
      "search-and-regex-builder",
      "command-palette",
