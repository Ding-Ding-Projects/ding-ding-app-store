import type { LockCredentialRequest, LockMutationResult, LockSetRequest, LockState, LockTarget, LockUnlockDuration, LockTotpAlgorithm, LockTotpDigits } from '../shared/contracts.js';
