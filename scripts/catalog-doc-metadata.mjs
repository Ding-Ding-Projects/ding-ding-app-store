...
export const CATALOG_ADAPTER_DOCUMENTATION = Object.freeze({
  ...
  'material-office': { adapterId: 'material-office-nsis', status: 'reviewed', family: 'NSIS', proofStatus: 'blocked-until-proof' },
  'minecraft-world-downloader': { adapterId: 'minecraft-world-downloader-squirrel', status: 'reviewed', family: 'Squirrel.Windows', proofStatus: 'blocked-until-proof' },
