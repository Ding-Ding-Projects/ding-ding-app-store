...
- [x] Local version browser: bounded Git snapshots with diff, labels, coordinated live reload, and explicit before/after restore revisions for settings, installed records, workspace, appearance, schedules, run metadata, and external-editor preference; credential vaults and staged update paths remain excluded
