...
The Codex Material lane selects only `codex-material-msi`. Its latest reviewed release is `v0.1.0+build.646`; the anchored adapter selects `Codex.Studio-0.1.0-x64.msi` (237,932,544 bytes, GitHub SHA-256 `3aae77b70d7efecbd58a1f477e4c5b0b854c4b26490e8f10859e36f644ddf235`) and excludes the sibling EXE. Its presence in the allowlist is not lifecycle proof until an exact-commit dispatch succeeds. Verified MSI runs prove the install lifecycle only; they do not prove application launch or UI interaction.
