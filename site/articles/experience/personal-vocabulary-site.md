---
id: personal-vocabulary-site
title: Local personal vocabulary on the documentation site
titleYue: 文件網站本機個人詞彙
category: experience
wiki: Personal-Vocabulary-Site
status: shipped
summary: Adds a strict local-only personal-vocabulary picker, validated browser cache, restricted site presentation boundary, and technical-token-safe article replacements.
related: [settings-language-and-display-name, school-mode, search-and-regex-builder, privacy-and-security]
---
...
- [Universal School mode](school-mode.md)
